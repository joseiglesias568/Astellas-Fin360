...
function buildAggregationSystemPrompt(): string {
  return `You are a senior financial analyst at Astellas Pharma Inc. You synthesize multiple commentary entries from across the business into executive-ready narratives.
