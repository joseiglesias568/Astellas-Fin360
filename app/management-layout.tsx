                            ...
                            >
                                ...
                                {isNavItemActive(item) && (
                                    <motion.div
                                        ...
                                        className="absolute bottom-0 left-3 right-3 h-0.5 bg-[#000000]"
                                                    ...
                                                    <Link
                                                        ...
                                                        className={`block px-4 py-3 transition-colors ${
                                                            isDropdownItemActive(subItem.href)
                                                                ? 'bg-[#000000]/5 border-l-2 border-[#000000]'
                                                                : 'hover:bg-gray-50 border-l-2 border-transparent'
                                                        }`}
                                                    >
                                                        <div className="flex items-center justify-between">
                                                            <span className={`text-sm font-medium ${
                                                                isDropdownItemActive(subItem.href) ? 'text-[#000000]' : 'text-gray-900'
                                                            }`}>
                                                                {subItem.label}
                                                            </span>
                                                        </div>
                                                                ...
                                                                {category.items.map((subItem) => (
                                                                    <Link
                                                                        ...
                                                                        className={`block px-2 py-1.5 rounded-md text-[13px] transition-colors ${
                                                                            isDropdownItemActive(subItem.href)
                                                                                ? 'bg-[#000000]/5 text-[#000000] font-medium'
                                                                                : subItem.comingSoon
                    ...
                    <div className="flex items-center space-x-3 flex-shrink-0">
                        ...
                        <div className="hidden md:block relative" ref={userMenuRef}>
                            ...
                            >
                                ...
                                <div className="w-9 h-9 rounded-full border-2 border-[#000000]/30 bg-[#000000] flex items-center justify-center">
                    ...
                    {showSearchModal && !isHomePage && (
                        ...
                        >
                            <div className="max-w-2xl mx-auto px-4 py-5">
                                <div className="group relative rounded-2xl bg-white shadow-[0_2px_12px_rgba(0,51,102,0.08)] border border-gray-200/80 hover:shadow-[0_4px_20px_rgba(0,51,102,0.12)] hover:border-[#000000]/20 transition-all duration-300 focus-within:shadow-[0_4px_20px_rgba(0,51,102,0.15)] focus-within:border-[#000000]/30">
                                    <div className="flex items-center">
                                        <div className="relative flex-1">
                                                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-[18px] h-[18px] text-gray-400 group-focus-within:text-[#000000] transition-colors duration-200" />
                                            <input
                                                type="text"
                                                value={searchQuery}
                                        ...
                                        <div className="pr-2">
                                            <button
                                                ...
                                                className="flex items-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-[#000000] to-[#000000] hover:from-[#1A1A1A] hover:to-[#000000] text-white text-sm font-semibold rounded-xl shadow-sm hover:shadow-md transition-all duration-200 whitespace-nowrap"
                                            >
                        ...
                        >
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        <Image
                                            ...
                                            unoptimized
                                        />
                                        <h2 className="text-lg font-bold text-white">Finance360</h2>
                                    </div>
                                    <button
                                        onClick={() => setIsMobileMenuOpen(false)}
                            ...
                            <div className="p-4 border-t border-gray-700">
                                <div className="flex items-center space-x-3 mb-3">
                                    <div className="w-10 h-10 rounded-full border-2 border-[#000000]/50 bg-[#000000] flex items-center justify-center">
            ...
            <footer className="bg-white border-t border-gray-200 py-3 px-4">
                <div className="flex items-center justify-center space-x-2">
                    ...
                    <Image
                        ...
                        unoptimized
                    />
                    <span className="text-xs text-gray-400">for Astellas Pharma Inc.</span>
                </div>
            </footer>
