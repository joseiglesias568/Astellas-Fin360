...
const parser = new Parser({
  timeout: 12_000,
  headers: {
    'User-Agent': 'Finance360/1.0 (+internal; pharmaceutical industry news ticker)',
...
const FEEDS: { url: string; source: string }[] = [
  {
    url: `https://news.google.com/rss/search?q=${encodeURIComponent(
      '("Astellas" OR "XTANDI" OR "enzalutamide" OR "PADCEV" OR "enfortumab vedotin" OR "VYLOY" OR "zolbetuximab" OR "IRA drug pricing" OR "oncology" OR "prostate cancer" OR "urothelial cancer") (pharma OR pharmaceutical OR "drug approval" OR "FDA" OR "EMA" OR "clinical trial" OR "ALPMY")',
    ...
    const payload =
      items.length > 0
        ? {
            ...
            disclaimer:
              'Headlines are from public RSS sources for situational awareness only — not verified by Astellas Pharma Inc.',
          }
        : {
            ...
            sources: [] as string[],
            disclaimer:
              'Live feeds unavailable; showing editorial placeholders. Headlines are not verified by Astellas Pharma Inc.',
          };
