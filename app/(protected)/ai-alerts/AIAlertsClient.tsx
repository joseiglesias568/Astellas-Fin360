                ...
                <div className="px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                            <div className="p-2 bg-gradient-to-br from-[#000000] to-[#000000] rounded-lg shadow-lg">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-[#000000] text-white rounded-lg font-semibold hover:bg-[#000000] transition-all flex items-center space-x-2"
                        >
                                        ...
                                        return (
                                            <React.Fragment key={alert.id}>
                                                ...
                                                >
                                                    ...
                                                    <td className="px-3 py-2.5 text-center">
                                                        <button
                                                            ...
                                                            className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors ${alert.enabled ? 'bg-[#000000]' : 'bg-gray-200'
                                                                }`}
                                                        >
                                                            <span
                                                        ...
                                                        <div className="flex items-center justify-center space-x-1">
                                                            {alert.suggestedActions && (
                                                                <button
                                                                    ...
                                                                    className="p-1 text-[#000000] hover:bg-[#F0F0F0] rounded transition-colors"
                                                ...
                                                {isExpanded && alert.suggestedActions && (
                                                    <tr>
                                                        <td colSpan={8} className="px-3 py-3 bg-[#F0F0F0]/40 border-t border-b border-[#000000]/20">
                                                            <div className="flex items-start space-x-2">
                                                                <Brain className="w-4 h-4 text-[#000000] mt-0.5 flex-shrink-0" />
                                                                <div className="flex-1">
                                                                    <p className="text-xs font-semibold text-[#000000] mb-1.5">AI Suggested Next Actions</p>
                                                                    <div className="grid grid-cols-2 gap-x-6 gap-y-1.5">
                                                                        {alert.suggestedActions.map((action, idx) => (
                                                                            <div key={idx} className="flex items-start space-x-1.5">
                                                                                <span className="text-[10px] font-bold text-[#000000] bg-[#F0F0F0] rounded-full w-4 h-4 flex items-center justify-center flex-shrink-0 mt-0.5">{idx + 1}</span>
                                        ...
                                        {categoryTemplates.map((template) => {
                                            ...
                                            return (
                                                <motion.div
                                                    ...
                                                    className="bg-white rounded-lg border border-gray-200 p-4 cursor-pointer hover:border-[#000000] hover:shadow-lg transition-all"
                                                    onClick={() => {
                                                ...
                                                >
                                                    <div className="flex items-start space-x-3">
                                                        <div className="p-2 bg-[#F0F0F0] rounded-lg">
                                                            <TplIcon className="w-5 h-5 text-[#000000]" />
                                                        </div>
                            ...
                            <div className="p-4 flex items-start space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center space-x-3 mt-1.5">
                                        ...
                                        <span className="text-[10px] text-[#000000] font-medium flex items-center"><Brain className="w-2.5 h-2.5 mr-0.5" />5 AI actions recommended</span>
                            ...
                            <div className="p-4 flex items-start space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center space-x-3 mt-1.5">
                                        ...
                                        <span className="text-[10px] text-[#000000] font-medium flex items-center"><Brain className="w-2.5 h-2.5 mr-0.5" />Property-level drill down available</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 flex items-start space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center space-x-3 mt-1.5">
                                        ...
                                        <span className="text-[10px] text-[#000000] font-medium flex items-center"><Brain className="w-2.5 h-2.5 mr-0.5" />Scenario analysis generated</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 flex items-start space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center space-x-3 mt-1.5">
                                        ...
                                        <span className="text-[10px] text-[#000000] font-medium flex items-center"><Brain className="w-2.5 h-2.5 mr-0.5" />Retention campaign recommended</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-4 flex items-start space-x-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center space-x-3 mt-1.5">
                                        ...
                                        <span className="text-[10px] text-[#000000] font-medium">Property operations review initiated</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="p-6">
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input
                                            type="number"
                                            className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-transparent"
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                        {[
                                            ...
                                            <label key={t.id} className={`flex flex-col p-2 border rounded-lg cursor-pointer hover:bg-gray-50 ${selectedTemplate?.alertType === t.id ? 'border-[#000000] bg-[#F0F0F0]/30' : 'border-gray-200'}`}>
                                        ...
                                        {channelOptions.map(channel => {
                                            ...
                                            return (
                                                <label key={channel.id} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                                                    <input type="checkbox" className="text-[#000000]" defaultChecked={channel.id === 'app' || channel.id === 'email'} />
                        ...
                        <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-[#000000] text-white rounded-lg font-semibold hover:bg-[#000000] transition-all"
                            >
                                Create Alert
                            </button>
                        </div>
