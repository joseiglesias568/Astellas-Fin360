...
// ── Chart constants ──────────────────────────────────────────────────
const CK = { green: '#000000', greenLight: '#1A1A1A', emerald: '#10B981', blue: '#3B82F6', amber: '#F59E0B', red: '#EF4444', gray: '#9CA3AF', grayLight: '#E5E7EB' };
const darkAxis = { fontSize: 9, fill: 'rgba(255,255,255,0.5)' };
const lightAxis = { fontSize: 10, fill: '#6B7280' };
const darkTooltip = { contentStyle: { background: '#000000', border: 'none', borderRadius: 8, fontSize: 11, color: '#fff', padding: '6px 10px' } };
const lightTooltip = { contentStyle: { background: '#fff', border: '1px solid #e5e7eb', borderRadius: 8, fontSize: 11, color: '#000000', padding: '6px 10px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' } };
...
function buildWaterfall(fin: FinancialConfig) {
    ...
    steps.push({ name: 'Actual', base: 0, value: running, color: '#000000' });
    return steps;
}
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white">
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-4">
                ...
                <motion.div
                    ...
                    className="mb-4 bg-gradient-to-br from-[#000000] via-[#000000] to-[#000000] rounded-xl p-6 border border-emerald-600/30 shadow-lg shadow-emerald-500/10"
                >
                    {/* Header row */}
                    ...
                    <div className="grid grid-cols-4 gap-5">
                        ...
                        <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                            ...
                            <p className="text-xs text-white/40 mb-4">SMT savings delivery · AI clinical trial efficiency</p>
                            {/* Supporting KPIs */}
                            <div className="grid grid-cols-2 gap-x-4 gap-y-2 mb-4">
                                <div>
                                    <p className="text-[11px] text-white/40">SMT FY26 Target</p>
                                    <p className="text-base font-bold text-emerald-400">¥40B</p>
                                </div>
                                <div>
                                    <p className="text-[11px] text-white/40">R&D Portfolio Opt.</p>
                                    <p className="text-base font-bold text-white">¥12B</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2.5 mt-1">
                                <div>
                                    <div className="flex justify-between text-[10px] mb-1">
                                        <span className="text-white/40">XTANDI TRx Growth vs Plan</span>
                                        <span className="text-white/70">+3% <span className="text-emerald-400">vs base case</span></span>
                                    </div>
                                ...
                                <div>
                                    <div className="flex justify-between text-[10px] mb-1">
                                        <span className="text-white/40">Finance360 FP&A Adoption</span>
                                        <span className="text-white/70">65% <span className="text-amber-400">vs 80% target</span></span>
                                    </div>
                                    <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                                        <div className="h-full bg-amber-400/60 rounded-full" style={{ width: '81%' }} />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-xl p-5 border border-white/10">
                            <p className="text-sm font-semibold text-white/50 uppercase tracking-wider mb-1">Market Access &amp; Reach</p>
                            <div className="flex items-baseline space-x-2 mb-1">
                                <span className="text-4xl font-extrabold text-white">50+</span>
                                <span className="text-sm font-bold text-amber-400">countries</span>
                            </div>
                            <p className="text-xs text-white/40 mb-4">XTANDI/PADCEV franchise reach · Strategic Brands ~100 markets</p>
                            {/* Segment stacked bar */}
                            <div className="mb-3">
                    ...
                    {activeView === 'overview' && (
                        ...
                        >
                            <p className="text-xs text-gray-500 px-1 max-w-4xl leading-relaxed">
                                Performance charts use merged quarterly data from Finance360&apos;s Astellas dataset (aligned to{' '}
                                <span className="font-medium text-gray-700">FY2025 Annual Securities Report</span>,{' '}
                                <span className="font-medium text-gray-700">Q1 FY2026 results presentation</span>, and cited earnings /
                                supplemental materials in <code className="text-[11px] bg-gray-100 px-1 rounded">config/clients/astellas/financials.ts</code>
                                ). Replace with live EDINET / data-lake ingest when available.
                            </p>
                            {['Commercial', 'Operational', 'Financial', 'Risk'].map((outcome) => {
                                ...
                                const outcomeColor = outcome === 'Commercial' ? 'border-l-[#000000]' :
                                    outcome === 'Operational' ? 'border-l-emerald-500' :
                                        outcome === 'Financial' ? 'border-l-green-500' : 'border-l-red-500';

                                const outcomeIcon = outcome === 'Commercial' ? <TrendingUp className="w-4 h-4 text-[#000000]" /> :
                                    ...
                                    <div key={outcome} className={`bg-white rounded-xl shadow-sm border border-gray-200 border-l-4 ${outcomeColor} overflow-hidden`}>
                                        ...
                                        <div className="px-5 py-3 flex items-center justify-between">
                                            <div className="flex items-center space-x-3">
                                                {outcomeIcon}
                                                <h3 className="text-sm font-bold text-[#000000]">{overviewUi.sectionTitle}</h3>
                                                                    ...
                                                                    <BarChart data={wfData} margin={{ top: 5, right: 10, bottom: 5, left: 6 }}>
                                                                        ...
                                                                        <Tooltip
                                                                            content={({ active, payload }) => {
                                                                                ...
                                                                                return (
                                                                                    <div
                                                                                        className="rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs text-[#000000]"
                                                            ...
                                                            >
                                                                <div className="flex items-center justify-between mb-1">
                                                                    <div className="flex items-center space-x-2">
                                                                        ...
                                                                        <span className="text-sm font-bold text-[#000000]">{insight.metric}</span>
                                                                    </div>
                                ...
                                return (
                                    <div className="bg-white rounded-xl shadow-sm p-4 mb-2 flex items-center justify-between">
                                        <div className="flex items-center space-x-6">
                                            <div className="flex items-center space-x-2">
                                                <span className="text-2xl font-bold text-[#000000]">{total}</span>
                                        ...
                                        <div className="flex items-center space-x-6">
                                            <div className="text-center">
                                                <p className="text-lg font-bold text-[#000000]">{pending}</p>
                                            ...
                                            <div className="h-8 w-px bg-gray-200" />
                                            <div className="text-center">
                                                <p className="text-lg font-bold text-[#000000]">{avgDays}</p>
                                    ...
                                    <div key={outcome} className="bg-white rounded-xl shadow-sm overflow-hidden">
                                        <div className={`p-4 border-b ${outcome === 'Commercial' ? 'bg-emerald-50 border-emerald-200' :
                                            ...
                                            <h2 className="text-lg font-semibold text-gray-900 flex items-center">
                                                {outcome === 'Commercial' && <TrendingUp className="w-5 h-5 mr-2 text-[#000000]" />}
                                                    ...
                                                    <div className="flex items-start justify-between">
                                                        <div className="flex-1">
                                                            <div className="flex items-center space-x-3 mb-2">
                                                                <h3 className="text-base font-medium text-[#000000]">{decision.title}</h3>
                                                        ...
                                                        <div className="ml-4 text-right">
                                                            <button className="px-4 py-2 bg-[#F0F0F0] text-[#000000] text-sm font-medium rounded-lg hover:shadow-lg hover:shadow-emerald-500/30 transition-all border border-emerald-400">
                                                                Review Decision
                                                            </button>
                        ...
                        >
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-6">
                                <h2 className="text-base font-semibold text-gray-900 mb-4 flex items-center">
                                    <Target className="w-4 h-4 mr-2 text-[#000000]" />
                        ...
                        >
                                    ...
                                    <div className="space-y-2">
                                        {selectedInsight.drivers.map((driver: string, idx: number) => (
                                            <div key={idx} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                                <div className={`w-2 h-2 rounded-full ${idx === 0 ? 'bg-[#D91E49]' : idx === 1 ? 'bg-amber-500' : 'bg-emerald-400'
                                                    }`} />
                                    ...
                                    <div className="space-y-3">
                                        {selectedInsight.actions.map((action: string, idx: number) => (
                                            <div key={idx} className="flex items-start space-x-3 p-4 bg-emerald-50 rounded-lg border border-emerald-200">
                                                <div className="flex-shrink-0 w-8 h-8 bg-[#D91E49] text-white rounded-lg flex items-center justify-center font-bold text-sm">
                                                    {idx + 1}
                                                </div>
                                                <div className="flex-1">
                                                ...
                                                <button className="text-sm font-medium text-[#000000] hover:text-[#000000]">
                                                    Assign →
                                                </button>
                                            </div>
                                        ))}
                            ...
                            <div className="bg-gray-50 px-6 py-4 border-t flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="px-6 py-2 text-sm font-medium text-white bg-[#D91E49] rounded-lg hover:bg-[#004A80] transition-colors flex items-center space-x-2"
                                >
