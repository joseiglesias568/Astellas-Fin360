        ...
        return (
            ...
            >
                ...
                {report.relatedConsoleId && CONSOLE_SHORT[report.relatedConsoleId] && (
                    <div className="flex items-center mb-2 text-xs text-[#000000] bg-[#F0F0F0]/50 rounded px-2 py-1">
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <div className="flex items-center space-x-6">
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-[#000000]">{allReports.length}</div>
                                ...
                                <div className="text-center">
                                    <div className="text-2xl font-bold text-[#000000]">{favorites.size}</div>
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="relative flex-1 max-w-2xl">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] bg-gray-50"
                                />
                            </div>
                            <button
                                onClick={() => setShowFilters(!showFilters)}
                                className={`px-4 py-3 rounded-lg border transition-colors flex items-center space-x-2 ${showFilters ? 'bg-[#F0F0F0] border-[#000000] text-[#000000]' : 'border-gray-200 hover:bg-gray-50'
                                    }`}
                            >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#000000]"
                                    >
                    ...
                    <div className="flex space-x-3 overflow-x-auto pb-2 scrollbar-hide">
                        {recentReports.slice(0, 8).map((report) => (
                            <button
                                ...
                                className="flex-shrink-0 bg-white border border-gray-200 rounded-lg px-4 py-2.5 hover:border-[#000000] hover:shadow-sm transition-all flex items-center space-x-2 min-w-[200px] max-w-[260px]"
                            >
                        ...
                        {filteredReports.length > displayCount && (
                            <div className="mt-6 text-center">
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-white border border-gray-300 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-50 hover:border-[#000000] hover:text-[#000000] transition-all"
                                >
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex-1">
                                        <div className="flex items-center space-x-3 mb-2">
                                            ...
                                            <span className={`px-2 py-1 text-xs rounded-full ${report.category === 'financial' ? 'bg-[#F0F0F0] text-[#000000]' :
                                                report.category === 'store-operations' ? 'bg-emerald-100 text-emerald-700' :
                                                    report.category === 'digital-loyalty' ? 'bg-[#F0F0F0] text-[#000000]' :
                                                        'bg-gray-100 text-gray-700'
                                                }`}>
                                                {report.category}
                                            </span>
            ...
            <AnimatePresence>
                {selectedReport && (
                    ...
                    >
                        ...
                        >
                            {/* Modal Header */}
                            <div className="relative bg-gradient-to-r from-[#000000] to-[#000000] p-6">
                                <button
                                    onClick={() => setSelectedReport(null)}
                                    ...
                                    <div className="md:col-span-2">
                                        ...
                                        {selectedReport.aiInsight && (
                                            <div className="bg-[#F0F0F0] rounded-lg p-4 mb-6">
                                                <h3 className="font-semibold text-[#000000] mb-2 flex items-center">
                                                    <Info className="w-4 h-4 mr-2" />
                                                    AI Insight
                                                </h3>
                                                <p className="text-[#000000] text-sm">{selectedReport.aiInsight}</p>
                                            </div>
                                        )}
                                        ...
                                        <div className="flex space-x-4">
                                            <button
                                                ...
                                                className="flex-1 px-6 py-3 bg-[#000000] text-white rounded-lg font-medium hover:bg-[#000000] transition-colors flex items-center justify-center"
                                            >
