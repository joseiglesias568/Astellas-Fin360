...
const titleToSegmentId: Record<string, string> = {
    // Astellas Pharma routable consoles — 4 have dedicated static pages, rest use [consoleid]
    'United States Oncology':          'north-america-performance',   // static page (Americas Performance)
    'International Oncology & Asia':   'international-performance',   // static page (Intl-Asia Performance)
    'Manufacturing & Supply Chain':    'store-operations',            // static page (Mfg & Supply Chain)
    'Digital Patient Programs':        'digital-loyalty',             // static page (Digital Patient)
    'Financial Performance':           'financial-performance',
    'Enterprise Risk':                 'enterprise-risk',
    'Pipeline & R&D':                  'specialty-pharmacy',
    'Medical Affairs & Clinical':      'oak-street-value-based-care',
    'Workforce & Culture':             'workforce-culture',
    'Sustainability & ESG':            'sustainability-esg',
    'Safety & Pharmacovigilance':      'safety-compliance',
    'Regulatory Affairs':              'clinical-quality',
    'IRA & Market Access':             'supply-chain-operations',
};

const consoleIconMap: Record<string, LucideIcon> = {
    'United States Oncology':          Heart,
    'International Oncology & Asia':   Globe,
    'Manufacturing & Supply Chain':    Building2,
    'Digital Patient Programs':        Smartphone,
    'Financial Performance':           DollarSign,
    'Enterprise Risk':                 Shield,
    'Pipeline & R&D':                  Package,
    'Medical Affairs & Clinical':      MapPin,
    'Workforce & Culture':             Users,
    'Sustainability & ESG':            Globe,
    'Safety & Pharmacovigilance':      Shield,
    'Regulatory Affairs':              Heart,
    'IRA & Market Access':             Truck,
};
...
const viewableConsoles = new Set([
    ...
    'International Oncology & Asia',
    'Manufacturing & Supply Chain',
    'Digital Patient Programs',
...
export default function BusinessConsolesClient({ dbConsoles }: BusinessConsolesClientProps) {
    ...
    const defaultConsoleId = (dbConsoles[0] && titleToSegmentId[dbConsoles[0].title]) ?? 'north-america-performance';
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="bg-white border-b border-gray-200">
                <div className="px-4 sm:px-6 lg:px-8 py-6">
                    <h1 className="text-3xl font-bold text-[#000000]">Business Insight Consoles</h1>
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-3 space-y-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000] focus:border-transparent"
                        />
                    </div>
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className={`rounded-xl border-2 cursor-pointer transition-all
                                            ${isSelected
                                                ? 'bg-[#000000] border-[#000000] shadow-lg'
