        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                        ...
                        {driverContributions[selectedMetric as keyof typeof driverContributions].map((driver) => (
                            <div key={driver.driver} className="relative">
                                ...
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                    <div
                                        className={`h-2 rounded-full transition-all ${driver.contribution > 0 ? 'bg-[#000000]' : 'bg-red-500'
                                            }`}
                                ...
                                return (
                                    <div key={item.name} className="flex-1 flex flex-col items-center">
                                        <div className="relative w-full">
                                            <div
                                                className={`w-full rounded-t-lg transition-all ${isStart || isEnd ? 'bg-[#000000]' :
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <button className="text-sm text-[#000000] hover:text-[#1A1A1A] font-medium">
                            View Details
                        </button>
                    </div>
                    ...
                    <div className="space-y-3">
                        {competitiveData.map((comp) => (
                            <div key={comp.competitor} className="relative">
                                <div className="flex items-center justify-between mb-1">
                                    <span className={`text-sm font-medium ${comp.competitor === 'Delta' ? 'text-[#000000]' : 'text-gray-700'
                                        }`}>
                                        {comp.competitor}
                                    </span>
                                    <div className="flex items-center space-x-2">
                                ...
                                <div className="w-full bg-gray-200 rounded-full h-3">
                                    <div
                                        className={`h-3 rounded-full transition-all ${comp.competitor === 'Delta' ? 'bg-[#000000]' : 'bg-gray-400'
                                            }`}
            ...
            <div className="bg-gradient-to-r from-[#F0F0F0] to-emerald-50 rounded-xl p-6 border border-[#000000]/20">
                <h4 className="font-semibold text-gray-900 mb-3 flex items-center">
                    <Layers className="w-5 h-5 mr-2 text-[#000000]" />
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-white rounded-lg p-4">
                        ...
                        <p className="text-sm text-[#000000] mt-1">
                            {dbData?.strategic?.keyOpportunities?.[0]?.revenueImpact ?? '+¥30B incremental revenue potential'}
                        </p>
                        <p className="text-xs text-gray-600 mt-2">
                            {dbData?.strategic?.keyOpportunities?.[0]?.description ?? 'Expand XTANDI and PADCEV AI-powered analytics across US oncology and urology prescriber base'}
                        </p>
                    </div>
                </div>
            </div>
