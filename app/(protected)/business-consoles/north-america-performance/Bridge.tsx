                ...
                <div className="relative">
                    <svg className="w-full" height="350" viewBox="0 0 1000 350">
                        ...
                        {chartData.map((item, index) => {
                            ...
                            const color = item.type === 'start' || item.type === 'end' ? '#000000' :
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button className="px-4 py-2 bg-[#000000] text-white rounded-lg font-medium hover:bg-[#1A1A1A] transition-all flex items-center space-x-2">
                                                            ...
                                                            {editingCommentary === item.id ? (
                                                                <div className="space-y-2">
                                                                    <textarea
                                                                        ...
                                                                        className="w-full p-2 border border-gray-300 rounded text-sm focus:outline-none focus:ring-2 focus:ring-[#000000]"
                                                                        rows={3}
                                                                    ...
                                                                    <div className="flex space-x-2">
                                                                        <button
                                                                            ...
                                                                            className="px-3 py-1 bg-[#000000] text-white rounded text-sm font-medium hover:bg-[#1A1A1A]"
                                                                        >
                                                                            Save
                                                                        </button>
                                                                        <button
