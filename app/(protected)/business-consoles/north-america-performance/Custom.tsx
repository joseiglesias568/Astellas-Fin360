...
const widgetChartData: Record<string, { type: 'area' | 'bar' | 'pie' | 'line'; data: any[] }> = {
    'fee-revenue-trend':   { type: 'area',  data: [{ q: 'Q1', v: 231 }, { q: 'Q2', v: 238 }, { q: 'Q3', v: 244 }, { q: 'Q4', v: 248 }] },
    'service-line-mix':    { type: 'bar',   data: [{ q: 'United States', v: 45 }, { q: 'Estab Markets', v: 22 }, { q: 'Japan', v: 18 }, { q: 'Intl Markets', v: 15 }] },
    'deal-cycle-speed':    { type: 'line',  data: [{ q: 'Jan', v: 4.2 }, { q: 'Feb', v: 4.0 }, { q: 'Mar', v: 3.8 }, { q: 'Apr', v: 3.5 }] },
    'office-profitability':{ type: 'pie',   data: [{ name: 'XTANDI', v: 45 }, { name: 'PADCEV', v: 28 }, { name: 'VEOZAH/IZERVAY', v: 14 }, { name: 'Other', v: 13 }] },
    'aum-growth':          { type: 'area',  data: [{ q: 'Q1', v: 518 }, { q: 'Q2', v: 528 }, { q: 'Q3', v: 540 }, { q: 'Q4', v: 555 }] },
    'client-engagement':   { type: 'bar',   data: [{ q: 'PSP Weekly', v: 28 }, { q: 'PSP Monthly', v: 42 }, { q: 'HCP Webinar', v: 18 }, { q: 'Portal Only', v: 12 }] },
    'revenue-per-producer':{ type: 'line',  data: [{ q: 'Q1', v: 62 }, { q: 'Q2', v: 64 }, { q: 'Q3', v: 66 }, { q: 'Q4', v: 68 }] },
    'client-retention':    { type: 'bar',   data: [{ q: 'Mo 3', v: 96 }, { q: 'Mo 6', v: 93 }, { q: 'Mo 12', v: 88 }, { q: 'Mo 24', v: 82 }] },
    'advisory-vs-ops':     { type: 'pie',   data: [{ name: 'Oncology', v: 72 }, { name: 'Urology', v: 28 }] },
    'cross-sell-rate':     { type: 'bar',   data: [{ q: 'XTANDI+PADCEV', v: 38 }, { q: 'XTANDI+VEOZAH', v: 22 }, { q: 'PADCEV+IZERVAY', v: 18 }, { q: 'Triple Combo', v: 12 }] },
    'platform-adoption':   { type: 'area',  data: [{ q: 'Jan', v: 52 }, { q: 'Feb', v: 58 }, { q: 'Mar', v: 63 }, { q: 'Apr', v: 69 }] },
    'new-service-impact':  { type: 'line',  data: [{ q: 'Wk1', v: 8 }, { q: 'Wk2', v: 12 }, { q: 'Wk3', v: 10 }, { q: 'Wk4', v: 9 }] },
    'peer-revenue-comparison': { type: 'bar',   data: [{ q: 'AstraZeneca', v: 2.18 }, { q: 'Pfizer', v: 2.41 }, { q: 'Novartis', v: 1.86 }] },
    'competitor-fees':         { type: 'bar',   data: [{ q: 'AstraZeneca', v: 3.5 }, { q: 'J&J', v: 3.8 }, { q: 'Merck', v: 1.9 }, { q: 'Roche', v: 4.1 }] },
    'market-share-map':        { type: 'pie',   data: [{ name: 'Astellas', v: 38 }, { name: 'AstraZeneca', v: 22 }, { name: 'Pfizer', v: 14 }, { name: 'Novartis', v: 15 }, { name: 'Other', v: 11 }] },
...
function WidgetChart({ widgetId }: { widgetId: string }) {
    ...
    const tooltipStyle = {
        contentStyle: { background: '#000000', border: 'none', borderRadius: 8, fontSize: 11, color: '#fff', padding: '6px 10px' },
...
export default function Custom() {
    const [savedDashboards, setSavedDashboards] = useState([
        ...
        {
            id: 2,
            name: 'Americas Oncology Revenue Analytics',
            description: 'XTANDI and PADCEV revenue trends, IRA price sensitivity, net price realization, and PSP-driven patient persistence by segment',
        ...
        {
            id: 3,
            name: 'Launch Brands & Digital Pipeline',
            description: 'Tracking VEOZAH and IZERVAY prescriber adoption pipeline and patient support program digital enrollment ramp',
    ...
    const availableWidgets = [
        {
            ...
            widgets: [
                ...
                { id: 'service-line-mix', name: 'Revenue Mix by Geography / Product', icon: BarChart3 },
                { id: 'deal-cycle-speed', name: 'Specialty Oncology Rx Fill Cycle', icon: Activity },
                { id: 'office-profitability', name: 'Segment Profitability by Product', icon: PieChart }
            ]
        },
        {
            category: 'Patient & HCP Engagement',
            widgets: [
                { id: 'aum-growth', name: 'PSP Enrollment Growth Trend', icon: LineChart },
                { id: 'client-engagement', name: 'Patient Digital Engagement Analysis', icon: BarChart3 },
                { id: 'revenue-per-producer', name: 'Revenue Per HCP Trend', icon: Activity },
                { id: 'client-retention', name: 'Patient Therapy Persistence Cohorts', icon: PieChart }
            ]
        },
        {
            category: 'Product & Platform',
            widgets: [
                { id: 'advisory-vs-ops', name: 'Oncology vs Urology Revenue Mix', icon: PieChart },
                { id: 'cross-sell-rate', name: 'Product Attach Rate (PSP Co-enrollment)', icon: BarChart3 },
                { id: 'platform-adoption', name: 'MyAstellas.com Patient Portal Adoption', icon: LineChart },
                { id: 'new-service-impact', name: 'VEOZAH/IZERVAY Prescriber Volume Impact', icon: Activity }
            ]
        },
        {
            category: 'Competitive Intelligence',
            widgets: [
                { id: 'peer-revenue-comparison', name: 'Peer Oncology Revenue Comparison', icon: BarChart3 },
                { id: 'competitor-fees', name: 'Competitor Net Price Benchmark', icon: List },
                { id: 'market-share-map', name: 'Oncology Segment Market Share', icon: Grid },
                { id: 'regional-coverage-map', name: 'Astellas Prescriber Network Footprint', icon: Grid }
            ]
        }
    ];
                ...
                <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
                    ...
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            placeholder="e.g., XTANDI IRA Sensitivity Tracker"
                                            ...
                                            return (
                                                <button
                                                    ...
                                                    className={`p-4 rounded-lg border-2 transition-all ${isSelected
                                                        ? 'border-[#000000] bg-[#F0F0F0]'
                                                        : 'border-gray-200 hover:border-gray-300'
                                                        }`}
                                                >
                                                    <div className="flex items-center space-x-3">
                                                        <div className={`p-2 rounded-lg ${isSelected ? 'bg-[#000000]/10' : 'bg-gray-100'
                                                            }`}>
                                                            <Icon className={`w-5 h-5 ${isSelected ? 'text-[#000000]' : 'text-gray-600'
                                                                }`} />
                                                        </div>
                                                        <span className={`text-sm font-medium ${isSelected ? 'text-[#000000]' : 'text-gray-700'
                                                            }`}>
                                                            {widget.name}
                                                        </span>
                                                    </div>
        ...
        return (
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6">
                    ...
                    {editMode && (
                        <div className="mt-4 p-4 bg-[#F0F0F0] rounded-lg border border-[#000000]/20">
            ...
            {!selectedDashboard ? (
                <>
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        <div className="flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="flex items-center space-x-2 px-4 py-2 bg-[#000000] text-white rounded-lg hover:bg-[#1A1A1A] transition-colors"
                            >
                    ...
                    <div className="grid grid-cols-3 gap-6">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {dashboard.widgets.slice(0, 3).map((widget) => (
                                            <span
                                                key={widget}
                                                className="inline-flex px-2 py-1 bg-[#F0F0F0] text-[#000000] text-xs rounded"
                                            >
                        ...
                        {/* Template Cards */}
                        <div className="bg-gradient-to-br from-[#F0F0F0] to-emerald-50 rounded-xl p-6 border border-[#000000]/20">
                            <div className="flex items-center justify-center h-full">
                                <div className="text-center">
                                    <div className="w-12 h-12 bg-[#000000]/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                                        <Grid className="w-6 h-6 text-[#000000]" />
                                    </div>
                                    <h4 className="text-sm font-medium text-gray-900 mb-1">
                                        Use a Template
                                    </h4>
                                    <p className="text-xs text-gray-600 mb-3">
                                        Start with pre-built Astellas Pharma dashboard templates
                                    </p>
                                    <button className="text-xs font-medium text-[#000000] hover:text-[#1A1A1A]">
                                        Browse Templates
                                    </button>
                                </div>
                            </div>
