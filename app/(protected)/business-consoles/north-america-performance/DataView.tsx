        ...
        <div className="space-y-6">
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                            <select
                                ...
                                className="px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#000000]"
                            >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="text-sm text-[#000000] hover:text-[#1A1A1A] font-medium flex items-center">
            ...
            <div className="bg-gradient-to-r from-[#F0F0F0] to-emerald-50 rounded-xl p-6 border border-[#000000]/20">
                <div className="flex items-center justify-between">
                    <div>
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 border rounded-lg text-sm font-medium transition-colors flex items-center ${showNotes ? 'bg-[#000000] text-white border-[#000000]' : 'bg-white border-gray-300 text-gray-700 hover:bg-gray-50'}`}
                        >
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-3">
                        <h4 className="font-semibold text-gray-900 flex items-center">
                            <MessageSquare className="w-4 h-4 mr-2 text-[#000000]" />
                            Analyst Notes
                        </h4>
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] resize-none"
                            rows={2}
                        />
                    </div>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                <div className="flex items-center justify-between mb-4">
                    <h4 className="font-semibold text-gray-900 flex items-center">
                        <Bookmark className="w-4 h-4 mr-2 text-[#000000]" />
                        Drill to Detailed Reports
                    </h4>
                    <Link href="/report-hub" className="text-sm text-[#000000] hover:underline">
                        Browse Report Hub
                    </Link>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    {[
                        ...
                        <Link
                            ...
                            className="group flex items-center space-x-3 bg-gray-50 hover:bg-[#F0F0F0]/30 border border-gray-200 hover:border-[#000000]/30 rounded-lg p-3 transition-all"
                        >
                            <div className="min-w-0 flex-1">
                                <div className="text-sm font-medium text-gray-900 group-hover:text-[#000000]">{report.name}</div>
                                <div className="text-xs text-gray-500 truncate">{report.desc}</div>
                            </div>
                            <ExternalLink className="w-4 h-4 text-gray-400 group-hover:text-[#000000] flex-shrink-0" />
                        </Link>
                    ))}
                </div>
            </div>
