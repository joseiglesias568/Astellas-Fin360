...
const DATA_SOURCES: DataSource[] = [
  {
    ...
    deltaExample: 'SAP S/4HANA — Astellas segment P&L (US/EM/Japan/Intl/China), Core OP by product/cost center, R&D expense, royalties, and adjusted earnings lines',
    useCases: ['Core OP Bridge', 'Cost Decomposition', 'MOR Automation', 'Earnings Prep'],
    ...
    keyFields: ['GL Account', 'Cost Center', 'Legal Entity', 'Segment (US/EM/Japan/Intl/China)', 'Period', 'Amount', 'Currency'],
  },
  {
    id: 'orders', name: 'Orders Management System (OMS)', category: 'Operational',
    description: 'Central source for product revenue, prescription volume, backlog, and revenue recognition schedule by segment and geography.',
    deltaExample: 'US/EM/Japan/Intl/China revenue by product line, XTANDI/PADCEV/VEOZAH TRx volume, by quarter',
    useCases: ['PADCEV Launch & Pipeline Monitor', 'Revenue Bridge', 'Segment Dashboard', 'NLQ Financial Q&A'],
  ...
  },
  {
    ...
    deltaExample: 'Veeva CRM — pipeline by product and therapeutic area, market access coverage by region, win rates vs. peers',
  ...
  },
  {
    ...
    deltaExample: 'Anaplan / SAP BPC — AOP by segment (US/EM/Japan/Intl/China), rolling Core OP forecast, product revenue plan and SMT cost targets',
    useCases: ['Core OP Bridge', '18-Month Forecast', 'Scenario Modeling', 'Board Reporting'],
  ...
  },
  {
    ...
    description: 'Multi-currency exposure by segment and region, hedge portfolio mark-to-market, and effective FX impact on Core OP.',
    deltaExample: 'Astellas Treasury — FX hedge positions (USD/JPY, EUR/JPY), MTM value, translation vs. transaction exposure by segment, hedge coverage rate',
    useCases: ['FX Exposure Analysis', 'Core OP Decomposition', 'Scenario Modeling', 'Risks & Opportunities'],
  ...
  },
  {
    ...
    description: 'Headcount, labor cost, and productivity metrics by segment, function, and geography. Links to Core OP cost bridge.',
    deltaExample: 'Workday — pharma headcount by function (R&D, Commercial, G&A), labor cost trends, SMT headcount reduction tracking by initiative',
  ...
  },
  {
    ...
    deltaExample: 'SAP Ariba — API and raw material procurement spend by category, CRO/CMO service costs, SMT savings vs. ¥40B FY26 target',
  ...
  {
    id: 'market', name: 'External Market & Pharma Data', category: 'External',
    description: 'IQVIA prescription data, pharma market share benchmarks, FDA pipeline databases, competitor data, and macro indicators for scenario assumptions.',
    deltaExample: 'IQVIA TRx data by product/geography, Bloomberg pharma feeds, FDA approval pipeline, IMS competitor share',
    useCases: ['Scenario Modeling', '18-Month Forecast', 'Competitive Intelligence', 'Risks & Opportunities'],
    extractFormat: 'API feeds (IQVIA, Bloomberg, FDA) or manual quarterly upload',
    refreshCadence: 'Weekly (TRx data); Monthly (market share, industry forecasts)',
    typicalReadiness: 'High',
    accessMethod: 'Third-party data APIs or structured Excel/JSON uploads',
    keyFields: ['Date', 'Indicator', 'Value', 'Source', 'Geography', 'Product/Segment'],
  },
];
    ...
    <div className="space-y-7 pb-12">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white rounded-xl border border-gray-200 p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            { icon: FileText, title: 'POC', items: ['Provide extract templates populated with sample data (SAP/TRx data)', 'Validate KPI definitions and business rules (Core OP, Revenue, XTANDI TRx, Core EPS)', 'Identify data quality issues before ingestion', 'Sign off on KPI values in Finance360 vs. source system'] },
