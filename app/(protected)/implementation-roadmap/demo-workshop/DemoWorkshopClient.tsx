...
const AGENDA = [
  ...
  },
  {
    ...
    activities: [
      ...
      'AI Q&A — natural language financial queries against Astellas pharma financial data model',
      'Scenario modeling demonstration: XTANDI IRA pricing, FX sensitivity, and Core EPS impact',
    ],
  ...
  },
  {
    ...
    activities: [
      'XTANDI Franchise console — US revenue drivers, IRA pricing exposure, Core OP margin bridge',
      'PADCEV / VEOZAH Launch Momentum — revenue by geography and channel vs. launch plan',
      'Strategic Brands & Pipeline Dashboard — VYLOY, IZERVAY launch metrics and market access by region',
  ...
  { time: '10:40 – 11:00', slot: 'Break', owner: '', type: 'break', activities: [], output: null },
  {
    ...
    activities: [
      ...
      'Planning & Forecasting: 18-month rolling Core OP forecast and bridge walk by segment',
...
const MODULES = [
  ...
  { id: 'consoles', label: 'Business Consoles (XTANDI, PADCEV, VEOZAH, SMT, FX)',       icon: TrendingUp,  recommended: true  },
  { id: 'ai-qna',   label: 'AI Q&A & Natural Language Search',                 icon: Cpu,         recommended: true  },
  { id: 'scenario', label: 'Scenario Modeling & XTANDI IRA / FX Stress Testing', icon: Shield,      recommended: true  },
  { id: 'ro',       label: 'Risks & Opportunities Register',                   icon: AlertCircle, recommended: false },
  { id: 'forecast', label: '18-Month Rolling Core EPS / Core OP Forecast',      icon: TrendingUp,  recommended: false },
...
const PREWORK = [
  { group: 'Client (Data/Finance Team)', items: [
    ...
    'Pull a sample of your product P&L (XTANDI, PADCEV, VEOZAH) and cost center hierarchy',
  ...
  { group: 'Accenture Delivery Team', items: [
    'Pre-configure Finance360 with Astellas branding, synthetic pharma KPI data, and scripted AI scenarios',
...
const ATTENDEES = [
  ...
  { role: 'US / Japan Segment Finance Lead',   why: 'Validate product KPIs, XTANDI IRA exposure, and Core EPS drivers',  required: false },
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">4-hour interactive session — live Finance360 walkthrough tailored to Astellas use cases and stakeholder audience</p>
          </div>
        </div>
      </motion.div>
