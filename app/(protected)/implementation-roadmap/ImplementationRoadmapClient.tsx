...
const PHASES: Phase[] = [
  ...
  },
  {
    ...
    objective: 'Validate core use cases using client-provided static data extracts from 2–4 priority sources. Deliver a working prototype with real financials, calibrated KPIs, and AI insights grounded in actual Astellas pharma business context.',
    deliverables: [
      { text: '2–4 data sources ingested from client-provided extracts', critical: true },
      { text: 'KPI definitions mapped to Astellas data model (Core OP, Revenue, XTANDI TRx, Core EPS)' },
  ...
  },
  {
    ...
    objective: 'Scale to the full enterprise user base with complete data ecosystem integration, advanced agentic capabilities, governance frameworks, and ongoing model optimization. Establish Finance360 as the system of intelligence for Astellas financial decision-making.',
    deliverables: [
    ...
    investment: 'High', accentColor: '#000000', bgColor: 'bg-gray-900', borderColor: 'border-gray-800', icon: TrendingUp,
...
const COMPLEXITY_FACTORS: ComplexityFactor[] = [
  { type: 'ERP / Financial System', examples: 'SAP S/4HANA, Oracle Fusion, Astellas legacy GL systems', delta: '+2 – 4 weeks / system', complexity: 'High' },
  { type: 'Orders & Backlog System', examples: 'SAP CS, Oracle CC&B, Astellas commercial operations system', delta: '+2 – 4 weeks / system', complexity: 'High' },
  ...
  { type: 'External / Market Data', examples: 'IQVIA TRx data, Bloomberg pharma feeds, FDA databases', delta: '+1 – 2 weeks / source', complexity: 'Low' },
      ...
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-0.5">Illustrative implementation roadmap — Demo to Production &bull; Finance360 for Astellas</p>
          </div>
