...
const days = [
    ...
    { num: 5, label: 'Day 5', sub: 'Publish & Distribute', color: '#000000' },
];
...
const activities: Activity[] = [
    ...
    },
    {
        ...
        detail: 'Watchdog scores each breach item. Team Lead routes structured escalation notifications to Americas Finance, Japan Finance, Established Markets Finance, and Corporate Finance. Each owner receives variance detail, EPM bridge link, and commentary deadline.',
    ...
    // Day 2 — Finance Owners
    {
        ...
        detail: 'Three owners submit commentary directly in Finance360 by the 4-hour SLA. Missouri Finance requests a launch investment breakdown (¥6.2B XTANDI commercial investment + ¥3.3B PADCEV launch costs). This triggers an agent revision cycle.',
    },
    // Day 2 — AI: Incorporate feedback
    {
        ...
        detail: 'Number Cruncher validates the ¥6.2B + ¥3.3B breakdown against the GL total, re-draws the EPM bridge, and propagates the update to the reconciliation table. Storyteller revises the commentary narrative to incorporate the owner\'s framing and forward look.',
    ...
    // Day 3 — Controller
    {
        ...
        detail: 'Controller reviews the full package. Reviews 14 pre-cleared lines quickly; focuses challenge time on the 4 escalated items. Edits XTANDI Revenue commentary in-line ("below-plan" → "XTANDI IRA headwind"). Approves 3 items; sends one back for additional sensitivity context.',
    },
    // Day 3 — AI: Sensitivity
    {
        ...
        timing: 'Same day',
        criteria: [
            'Additional sensitivity analysis run on SMT Phase 2 Costs',
        ...
        detail: 'Number Cruncher runs SMT Phase 2 cost sensitivity under two implementation scenarios. Storyteller adds a quantified forward range to the commentary. Updated item returned to Controller within the hour.',
        output: 'SMT Phase 2: Q2 savings run-rate range ¥3.8B–¥5.2B annualised | cleared same day',
    },
    ...
    // Day 4 — Controller/CFO
    {
        ...
        detail: 'CFO reviews the pre-read package in Finance360. Raises two questions on the Americas XTANDI revenue shortfall variance. FP&A responds within the tool — responses logged with timestamps and version-controlled against the commentary package.',
    },
    // Day 4 — AI: Final consolidation
    {
        ...
        timing: 'Afternoon',
        criteria: [
            'Americas, Japan, Established Markets, and Corporate segment bridges merged',
        ...
        detail: 'Number Cruncher merges Americas, Japan, Established Markets, and Corporate segment variance bridges into the total company view. EPS bridge computed using current diluted share count. All totals validated against GL control totals before locks.',
...
const closeKPIs = [
    { label: 'Close Cycle', value: '5 days', sub: 'Day 1–5, March 2026', color: '#000000' },
        ...
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}>
                    <p className="text-xs font-bold text-[#000000] uppercase tracking-widest mb-1">Process Flow — Swimlane View</p>
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={`w-full text-left rounded-xl border p-2.5 transition-all ${
                                                            isSelected
                                                                ? 'border-[#000000] shadow-md ring-1 ring-[#000000]/20 bg-white'
                                                                : act.escalation
                ...
                <section>
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}>
                        <p className="text-xs font-bold text-[#000000] uppercase tracking-widest mb-1">Daily Activity Log</p>
                ...
                <section>
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}>
                        <p className="text-xs font-bold text-[#000000] uppercase tracking-widest mb-1">Escalation Policy</p>
                        ...
                        {[
                            {
                                ...
                                desc: 'Any P&L line where the plan-vs-actual variance exceeds ¥5B in either direction.',
                                color: '#B45309',
                                bg: '#FFFBEB',
                                icon: AlertTriangle,
                            },
                            ...
                            },
                            {
                                ...
                                desc: 'For lines with plan <¥50B: escalate if variance exceeds both ¥2B and 3% simultaneously.',
                                color: '#7C3AED',
                                bg: '#F5F3FF',
                                icon: Zap,
                            },
                ...
                <motion.div
                    initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}
                    className="bg-gradient-to-br from-[#000000] to-[#000000] rounded-3xl p-8 text-white flex flex-col md:flex-row items-start md:items-center gap-6"
                >
