...
export default function ThreadSidebar({
  ...
  if (isCollapsed) {
    return (
      <div className="w-14 border-r border-gray-200/50 bg-[#000000] flex flex-col items-center py-4 gap-3">
        ...
        <button onClick={onNewChat} className="p-2 rounded-lg bg-[#000000] hover:bg-[#1A1A1A] text-white transition-colors shadow-sm" title="New chat">
  ...
  return (
    <div className="w-72 border-r border-gray-200/50 bg-[#000000] flex flex-col h-full">
      {/* Header */}
      <div className="p-3 flex items-center justify-between border-b border-white/10">
        ...
        <button
          onClick={onNewChat}
          className="flex items-center gap-2 px-3 py-2 bg-[#000000] hover:bg-[#1A1A1A] text-white text-sm font-medium rounded-lg transition-all shadow-sm hover:shadow"
        >
        ...
        <div className="px-3 pt-3 pb-1">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 text-xs bg-white/5 border border-white/10 rounded-lg text-white placeholder-white/30 focus:outline-none focus:ring-1 focus:ring-[#000000] focus:bg-white/10 transition-all"
            />
          </div>
        </div>
      )}
                      ...
                      {editingId === thread.id ? (
                        <div className="flex items-center gap-1 px-2 py-2">
                          <input
                            ...
                            className="flex-1 px-2.5 py-1.5 text-xs bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-1 focus:ring-[#000000]"
                            autoFocus
                          />
