...
const categoryConfig = {
    insights: { icon: Brain, color: 'emerald', bgColor: 'bg-[#F0F0F0]/30', borderColor: 'border-[#F0F0F0]', textColor: 'text-[#000000]', badgeBg: 'bg-[#F0F0F0]', badgeText: 'text-[#000000]', buttonBg: 'bg-[#000000]', label: 'Insights & Discovery' },
    reporting: { icon: FileText, color: 'green', bgColor: 'bg-[#F0F0F0]', borderColor: 'border-[#000000]/20', textColor: 'text-[#000000]', badgeBg: 'bg-[#F0F0F0]', badgeText: 'text-[#000000]', buttonBg: 'bg-[#000000]', label: 'Reporting & Narratives' },
            ...
            >
                <div className="flex items-start space-x-4">
                    <div className="p-3 bg-[#F0F0F0] rounded-lg">
                        <Network className="w-6 h-6 text-[#000000]" />
                    </div>
                    <div className="flex-1">
                        ...
                        <div className="mt-4 p-4 bg-gradient-to-r from-[#F0F0F0]/30 to-[#F0F0F0]/30 rounded-lg border border-[#F0F0F0]">
                            <div className="flex items-start space-x-3">
                                <Zap className="w-5 h-5 text-[#000000] mt-0.5 flex-shrink-0" />
                                <div className="text-sm text-gray-700">
                                    <strong className="text-[#000000]">Behind the Scenes:</strong> Agents work autonomously to process data, generate insights, and orchestrate workflows. 
                                    <strong className="text-[#000000]"> User Interaction Points</strong> are clearly marked where you can review, modify, or approve agent outputs.
                                </div>
                            </div>
                        </div>
                            ...
                            <button
                                ...
                                className={`p-4 rounded-lg border-2 text-left transition-all ${
                                    selectedWorkflow.id === workflow.id
                                        ? 'border-[#000000] bg-[#F0F0F0]/30 shadow-md'
                    ...
                    <div className="flex items-center space-x-2">
                        {isAnimating && !isPaused ? (
                            <button
                                ...
                                className="flex items-center space-x-2 px-6 py-3 bg-[#000000] text-white rounded-lg font-medium hover:shadow-lg transition-all"
                            >
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-center">
                        <div className="flex items-center space-x-3 px-5 py-3 bg-gradient-to-r from-[#F0F0F0] to-[#F0F0F0] rounded-lg border-2 border-[#F0F0F0] shadow-md">
                            ...
                            <div>
                                <div className="text-xs font-semibold text-[#000000] uppercase tracking-wide">User Interaction</div>
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                className={`flex items-start space-x-3 p-3 rounded-lg cursor-pointer transition-all ${
                                                    isActive
                                                        ? 'bg-[#F0F0F0] border-2 border-[#000000] shadow-md'
                                                        : isCompleted
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center space-x-2 mb-1">
                                                        {Icon && <Icon className={`w-4 h-4 flex-shrink-0 ${
                                                            isActive ? 'text-[#000000]' : isCompleted ? 'text-green-600' : 'text-gray-400'
                                                        }`} />}
                                                        <h4 className={`text-sm font-semibold ${
                                                            isActive ? 'text-[#000000]' : isCompleted ? 'text-green-900' : 'text-gray-700'
                                                        }`}>
                                                    ...
                                                    {isActive && (
                                                        <motion.div
                                                            ...
                                                            className="text-xs text-[#000000] font-medium"
                                                        >
                                                            Processing...
                                                        </motion.div>
                                                    )}
                    ...
                    <div className="lg:col-span-2">
                        {selectedWorkflow && selectedWorkflow.steps && activeStepIndex >= 0 && activeStepIndex < selectedWorkflow.steps.length ? (
                            <motion.div
                                ...
                                className="bg-white rounded-xl border-2 border-[#000000] shadow-lg overflow-hidden"
                            >
                                {(() => {
                                        ...
                                        <>
                                            ...
                                            <div className="bg-gradient-to-r from-[#F0F0F0]/30 to-[#F0F0F0] px-6 py-5 border-b border-[#F0F0F0]">
                                                <div className="flex items-center space-x-4 mb-3">
                                                    <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#000000] text-white flex items-center justify-center font-bold text-lg shadow-md">
                                                        {activeStepIndex + 1}
                                                    </div>
                                                    <div className="flex-1">
                                                        <div className="flex items-center space-x-3 mb-2">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        {step.agents.map((agent) => (
                                                            <motion.div
                                                                ...
                                                                transition={{ duration: 1.5, repeat: Infinity }}
                                                                className="px-4 py-2 rounded-lg bg-[#000000] text-white font-medium text-sm flex items-center space-x-2 shadow-md"
                                                            >
                                            ...
                                            {/* User Interaction */}
                                            {hasUserInteraction && (
                                                <div className="px-6 py-4 bg-[#F0F0F0] border-b border-[#000000]/20">
                                                    <div className="flex items-center space-x-2">
                                                        <Users className="w-5 h-5 text-[#000000]" />
                                            ...
                                            {step.data && (
                                                <div className="px-6 py-4 bg-[#F0F0F0]/20 border-b border-[#F0F0F0]">
                                                    <div className="flex items-start space-x-3">
                                                        <Database className="w-5 h-5 text-[#000000] mt-0.5 flex-shrink-0" />
                                                        <div className="flex-1">
                                                            <div className="text-xs font-semibold text-gray-700 mb-1 uppercase tracking-wide">Data Flow</div>
                                                            <div className="text-sm text-[#000000]">{step.data}</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            )}
                                            ...
                                            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div className="flex items-start space-x-2">
                                                        <Activity className="w-4 h-4 text-[#000000] mt-0.5 flex-shrink-0" />
                                                        <div>
                                                    ...
                                                    {/* Step Position */}
                                                    <div className="flex items-start space-x-2">
                                                        <Target className="w-4 h-4 text-[#000000] mt-0.5 flex-shrink-0" />
                                                        <div>
