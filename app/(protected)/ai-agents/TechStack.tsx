        ...
        <div className="space-y-8">
            ...
            >
                <div className="flex items-start space-x-4">
                    <div className="p-3 bg-[#F0F0F0] rounded-lg">
                        <Layers className="w-6 h-6 text-[#000000]" />
                    </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mt-6">
                            {techLayers.map((layer) => (
                                <div key={layer.name} className="text-center p-3 bg-gray-50 rounded-lg">
                                    <div className="text-2xl font-bold text-[#000000]">{layer.technologies.length}</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="p-5">
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center space-x-3">
                                            <div className="w-8 h-8 rounded-full bg-[#000000] text-white flex items-center justify-center text-sm font-bold">
                                                {index + 1}
                                            </div>
                                            <div>
                                    ...
                                    <div className="flex flex-wrap gap-2 mt-4 ml-11">
                                        {layer.technologies.map((tech) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <TechIcon className="w-4 h-4 text-[#000000]" />
                                                    <span className="text-sm font-medium text-[#000000]">{tech.name}</span>
                                                </div>
                                            );
                                        })}
                                    </div>
                ...
                <div>
                    ...
                    >
                        <div className="h-2 bg-gradient-to-r from-[#000000] to-[#000000]" />
                                ...
                                return (
                                    <div key={pillar.name}>
                                        <div className="flex items-start space-x-3 py-4">
                                            <div className="p-2 bg-gradient-to-br from-[#000000] to-[#000000] rounded-lg flex-shrink-0">
                    ...
                    <motion.div
                        ...
                        className="mt-4 p-4 bg-[#F0F0F0]/30 rounded-lg border border-[#000000]/10"
                    >
