    ...
    return (
        <div className="flex justify-center py-1">
            <div className="flex flex-col items-center">
                <div className="w-0.5 h-3 bg-[#000000]/20" />
                <ArrowDown className="w-5 h-5 text-[#000000]/40" />
                <div className="w-0.5 h-3 bg-[#000000]/20" />
            </div>
        </div>
    );
    ...
    return (
        <div className="space-y-8">
            ...
            >
                <div className="flex items-start space-x-4">
                    <div className="p-3 bg-[#F0F0F0] rounded-lg">
                        <Server className="w-6 h-6 text-[#000000]" />
                    </div>
                                ...
                                <div className="p-5">
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center space-x-3">
                                            <div className="p-2 bg-gradient-to-br from-[#000000] to-[#000000] rounded-lg">
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex items-center space-x-2 mb-3">
                                                            <SectionIcon className="w-4 h-4 text-[#000000]" />
                                                            ...
                                                            {section.items.map((item) => (
                                                                item.href ? (
                                                                    <Link
                                                                        key={item.label}
                                                                        href={item.href}
                                                                        className="flex items-center justify-between text-xs text-[#000000] bg-white rounded px-2.5 py-1.5 border border-gray-100 hover:bg-[#F0F0F0]/50 hover:border-[#000000]/20 transition-colors group"
                                                                    >
                                            ...
                                            {row.sections[0].items.map((item) => (
                                                item.href ? (
                                                    <Link
                                                        key={item.label}
                                                        href={item.href}
                                                        className="flex items-center gap-1.5 px-3 py-2 bg-[#F0F0F0] rounded-lg hover:bg-[#000000]/20 transition-colors group"
                                                    >
                                                        <span className="text-sm font-medium text-[#000000]">{item.label}</span>
                                                        <ExternalLink className="w-3 h-3 text-[#000000] opacity-0 group-hover:opacity-100 transition-opacity" />
                                                    </Link>
                                                ) : (
                                                    <div
                                                        key={item.label}
                    ...
                    {keyConsiderations.map((consideration, index) => (
                        ...
                        >
                            <div className="flex items-start space-x-3">
                                <div className="w-8 h-8 rounded-full bg-[#000000] text-white flex items-center justify-center text-sm font-bold flex-shrink-0">
                                    {consideration.id}
                                </div>
            ...
            <motion.div
                ...
                className="p-4 bg-[#F0F0F0]/30 rounded-lg border border-[#000000]/10"
            >
