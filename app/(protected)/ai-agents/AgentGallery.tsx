...
const categoryColors = {
    orchestrator: 'from-[#000000] to-[#000000]',
    super: 'from-[#000000] to-[#000000]',
    utility: 'from-[#1A1A1A] to-[#000000]'
};
                    ...
                    <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
                            <div className="p-4 bg-[#F0F0F0]/30 rounded-lg">
                                <div className="text-2xl font-bold text-[#000000]">1</div>
                            ...
                            <div className="p-4 bg-[#F0F0F0] rounded-lg">
                                <div className="text-2xl font-bold text-[#000000]">5</div>
                            ...
                            <div className="p-4 bg-emerald-50 rounded-lg">
                                <div className="text-2xl font-bold text-[#000000]">{agents.filter(a => a.category === 'utility' && a.status === 'active').length}</div>
                        ...
                        <div className="mt-4 p-3 bg-[#F0F0F0] rounded-lg border border-[#000000]/20">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center text-[#000000] text-sm font-medium group-hover:gap-2 transition-all">
                                    ...
                                    <ul className="space-y-2">
                                        {selectedAgent.responsibilities.map((resp, idx) => (
                                            <li key={idx} className="flex items-start space-x-2">
                                                <CheckCircle className="w-5 h-5 text-[#000000] mt-0.5 flex-shrink-0" />
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedAgent.workflows.map((workflowId) => {
                                                ...
                                                return workflow ? (
                                                    <span key={workflowId} className="px-3 py-1 bg-[#F0F0F0] text-[#000000] text-sm rounded-full">
                                                        {workflow.name}
                                                    </span>
                                                ) : null;
                                            })}
