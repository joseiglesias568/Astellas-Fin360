        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="flex items-center gap-6 mt-3 text-[10px] text-gray-500">
            <span className="flex items-center gap-1.5">
              <span className="w-3 h-0.5 bg-[#D91E49] rounded" /> Revenue
            </span>
            <span className="flex items-center gap-1.5">
        ...
        <div className="bg-gradient-to-r from-[#1A1A1A] to-[#2A2A2A] rounded-xl p-6 text-white">
          ...
          <div className="mb-5 flex items-start gap-2 bg-amber-400/15 border border-amber-400/30 rounded-lg px-3 py-2">
            ...
            <p className="text-[11px] text-amber-200 leading-snug">
              ...
              The ¥250 Core EPS guidance was issued at Q1 FY26 results (Jul 2025) and reflects current Astellas planning assumptions including XTANDI IRA pricing, SMT savings delivery, and USD/JPY at ¥151 planning rate.
              FY26 guidance confirmed at Q1 FY26 results. Core EPS ¥250, Core OP ¥580B (+4.4%), Revenue ¥2,210B (+3.3%).
            </p>
          </div>
            ...
            {forwardOutlook.filter(p => p.period !== lastActualLabel).map((period) => {
              ...
              return (
                <div key={period.period} className="border border-gray-200 rounded-lg overflow-hidden">
                  ...
                  >
                    <span className="text-sm font-semibold text-[#000000]">{period.period}</span>
                        ...
                        <div className="px-4 pb-3 space-y-1.5">
                          {period.keyAssumptions.map((assumption, idx) => (
                            <div key={idx} className="flex items-start text-sm text-gray-600">
                              <span className="flex-shrink-0 w-1.5 h-1.5 mt-2 mr-3 rounded-full bg-[#000000]" />
                              {assumption}
                            </div>
                          ))}
                        </div>
