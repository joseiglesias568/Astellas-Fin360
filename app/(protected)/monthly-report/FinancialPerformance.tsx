  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          <div key={m.label} className="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p className="text-2xl font-bold text-[#000000]">{m.value}</p>
      ...
      <p className="text-[10px] text-gray-400 -mt-1">
        * Plan values reflect internal management budget estimates. Astellas Pharma Inc. does not publicly file quarterly segment budgets — these figures are not independently verifiable from published IR filings.
      </p>
