      ...
      <AnimatePresence>
        {selectedRisk && (
          ...
          >
            ...
            <div className="mt-3 p-3 bg-[#F0F0F0]/30 rounded-lg border border-[#000000]/10">
              <p className="text-xs font-semibold text-[#000000] mb-1">Mitigation Strategy</p>
              <p className="text-sm text-[#000000]">{selectedRisk.mitigation}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
