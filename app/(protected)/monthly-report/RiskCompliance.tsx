...
export default function RiskCompliance({ periodLabel, strategic, market }: RiskComplianceProps) {
  ...
  // Sort competitors by market share descending for chart, include Astellas
  const companyEntry = {
    name: 'Astellas',
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-4">
          ...
          <p className="text-2xl font-bold text-[#000000]">{market?.companyMarketShare?.toFixed(1) ?? 0}%</p>
