...
export default function ExecutiveDashboard({
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-[#000000] to-[#000000] rounded-xl shadow-lg p-6 text-white">
      ...
      <div>
        ...
        <div className="space-y-2">
          {topActions.map((action) => {
            ...
            return (
              <div key={action.id} className="border border-gray-200 rounded-lg overflow-hidden hover:border-[#000000]/30 transition-colors">
                <button
                ...
                >
                  ...
                  <span className="px-2 py-0.5 bg-[#F0F0F0] text-[#000000] rounded text-[10px] font-semibold shrink-0">
                    {action.category}
                  </span>
