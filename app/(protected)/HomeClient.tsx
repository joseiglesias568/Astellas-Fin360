...
const suggestedQueries = [
    'How is XTANDI trending vs. IRA price risk?',
    'What is our Core Operating Profit margin?',
    'How is PADCEV uptake tracking vs. plan?',
    'What is the FX impact on Core OP this quarter?',
];
            ...
            <div className="relative overflow-hidden px-8" style={{ background: 'linear-gradient(135deg, #000000 0%, #003322 30%, #000000 70%, #000000 100%)' }}>
                ...
                <div className="max-w-7xl mx-auto pt-20 pb-16">
                        ...
                        <div className="max-w-2xl mx-auto">
                            <div className="relative">
                                ...
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 transform -translate-y-1/2 p-2.5 bg-[#F0F0F0] text-[#000000] rounded-xl hover:bg-[#000000] hover:text-white transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                                >
                    ...
                    <HomeTileSection
                        ...
                        sectionSubtitle="CFO scoreboard — Core EPS, Core Operating Profit, free cash flow, and R&D intensity — within a 3-year framework of XTANDI/PADCEV franchise defense, pipeline investment, and SMT cost discipline."
            ...
            <div className="px-8 py-8">
                <div className="max-w-7xl mx-auto space-y-8">
                    ...
                    <HomeTileSection
                        ...
                        sectionSubtitle="PADCEV label expansion, VEOZAH launch trajectory, XTANDI IRA defense, and SMT savings delivery (per Astellas investor materials & IR commentary)."
