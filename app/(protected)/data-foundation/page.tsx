...
const dataTypes = [
    {
        ...
        description: 'Financial results, cost records, operational metrics, and workforce data generated inside Astellas Pharma Inc. every day. This is the most trusted source — produced by people who own the outcomes.',
        examples: [
            { label: 'Financial systems', detail: 'General ledger, revenue actuals, cost center detail, balance sheet' },
            { label: 'Product revenue', detail: 'XTANDI/PADCEV/VYLOY/IZERVAY/VEOZAH net sales by geography and quarter; royalty revenue; milestone payments' },
            { label: 'Operations', detail: 'R&D expense by program, SMT savings by initiative, manufacturing cost by product, clinical trial milestones' },
            { label: 'Workforce', detail: 'Headcount by function, R&D FTE by therapy area, SG&A labor cost by commercial region and SMT restructuring program' },
        ],
    },
    {
        ...
        description: 'Numbers that exist outside Astellas Pharma Inc.\'s walls — from public filings, markets, and third-party data providers — that give context to your own performance.',
        examples: [
            { label: 'Public filings', detail: 'Peer pharma Annual Reports / 20-F / 6-K revenue, margin, and pipeline data (Pfizer, Merck, AstraZeneca, Novo Nordisk, J&J)' },
            { label: 'Pharmaceutical market data', detail: 'IRA drug pricing outcomes, oncology market share (IQVIA), ADC class competitive landscape, NHI revision rate history' },
            { label: 'Market & macro', detail: 'JPY/USD exchange rates, Japan NHI pricing databases, FDA/EMA/PMDA regulatory approval calendars' },
            { label: 'Regulatory engagement data', detail: 'IRA Medicare drug negotiation results, Japan biennial NHI revision schedules, EU reimbursement decision timelines' },
        ],
    },
    {
    ...
    },
    {
        ...
        examples: [
            ...
            { label: 'Industry news', detail: 'Drug pricing legislation, IRA negotiation outcomes, ADC approvals, oncology competitor label expansions, FDA/EMA advisory committee decisions' },
            { label: 'Regulatory filings', detail: 'FDA New Drug Application reviews, EMA Committee for Medicinal Products summaries, PMDA Japan approval records, clinical trial registries (ClinicalTrials.gov)' },
        ],
    },
];
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            <div className="max-w-6xl mx-auto px-6 py-12 space-y-20">
                ...
                <section>
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}>
                        ...
                        <div className="flex items-center gap-2 mb-8 px-4 py-2.5 bg-[#F0F0F0] rounded-lg w-fit">
                            ...
                            <span className="text-xs font-medium text-[#000000]">Finance360 is currently operating at Stage 4 — Activated — for Astellas Pharma Inc.'s core financial domains.</span>
                        </div>
                    </motion.div>
                        ...
                        {maturityStages.map((s, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`rounded-2xl border p-5 ${isCurrentOrBeyond ? 'border-[#000000]/20 bg-[#F0F0F0]/30' : 'bg-white border-gray-200'}`}
                                >
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            <div className="flex flex-wrap items-center gap-2 mb-1">
                                                ...
                                                {i === 3 && <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#000000] text-white">Current — Finance360</span>}
                                            </div>
                ...
                <section>
                    <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={fade} transition={{ duration: 0.4 }}>
                        <p className="text-xs font-bold text-[#000000] uppercase tracking-widest mb-1">Section 4</p>
                ...
                >
                    <div className="flex items-start gap-4 mb-6">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-gray-900 mb-1">Where Astellas Finance360 sits today.</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                            { icon: Database, label: 'Structured financial data', detail: 'Q1 FY25 – Q1 FY26 quarterly results, product net sales, P&L, bridge items, and KPIs are certified and cited to Astellas Annual Report and IR presentations.', color: '#000000' },
                            { icon: Globe, label: 'External data joined in', detail: 'Peer pharma Annual Reports, IRA drug pricing outcomes, Japan NHI revision rates, and oncology market share benchmarks are sourced and tagged alongside internal data.', color: '#0070C0' },
                            { icon: FileText, label: 'Unstructured data activated', detail: '800+ AI-generated insights and 35+ commentary entries drawn from Astellas earnings transcripts, IR presentations, and investor conference decks.', color: '#7C3AED' },
                            { icon: Shield, label: 'Provenance as governance', detail: 'Every value is tagged [CITED], [DERIVED], [INTERPOLATED], or [ASSUMED] — a lightweight but effective governance layer aligned with Astellas IR disclosure standards.', color: '#9F1239' },
                            { icon: Key, label: 'Next step: Stage 5', detail: 'Moving to full governance means assigning data product owners, setting quality SLAs, and connecting to Astellas live operational and regulatory systems rather than seed data.', color: '#065F46' },
                            { icon: Clock, label: 'Production path', detail: 'Live Neon/Databricks integration, automated EDGAR/TSE ingestion for peer pharma filings, real-time IQVIA market data, and FDA/EMA calendar feeds are the natural next builds.', color: '#B45309' },
                        ].map((item) => {
