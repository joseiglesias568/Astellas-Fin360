    ...
    <div className="bg-white border-b border-gray-200 px-4 py-3">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <Stat icon={User} label="Human Commentary" value={totalHuman} color="text-[#000000]" bg="bg-[#F0F0F0]" />
          ...
          <div className="text-xs text-gray-500">
            <span className="font-semibold text-[#000000] text-sm">{consoleCount}</span> Consoles
          </div>
          {filtered && (
            <>
              <div className="w-px h-8 bg-gray-200" />
              <div className="text-xs font-medium text-[#000000] bg-[#F0F0F0] px-2 py-1 rounded">
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <div className="leading-tight">
        <span className="font-semibold text-sm text-[#000000]">{value.toLocaleString()}</span>
