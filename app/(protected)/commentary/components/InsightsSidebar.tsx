      ...
      <div className="p-3 space-y-1">
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-[#000000]">Filters</span>
            {activeCount > 0 && (
              <span className="bg-[#000000] text-white text-xs px-1.5 py-0.5 rounded-full">
                {activeCount}
              </span>
            )}
          </div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-8 pr-8 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-[#000000] focus:border-[#000000]"
          />
          {filters.search && (
            <button
  ...
  return (
    <label className="flex items-center gap-2 py-1 px-1 rounded hover:bg-gray-100 cursor-pointer group">
      <input
        ...
        checked={checked}
        onChange={onToggle}
        className="w-3.5 h-3.5 rounded border-gray-300 text-[#000000] focus:ring-[#000000] accent-[#000000]"
      />
      {dot}
