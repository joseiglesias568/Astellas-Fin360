...
function SignalDetailModal({
    ...
    return (
        ...
        >
            ...
            >
                <div className="flex items-start justify-between gap-4 px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-[#000000] to-[#000000] text-white shrink-0">
                ...
                <div className="overflow-y-auto flex-1 min-h-0 px-6 py-5 space-y-5">
                    <div className="flex flex-wrap gap-2 items-center">
                        ...
                        <span className="text-xs text-gray-600 flex items-center gap-1">
                            <Target className="w-3.5 h-3.5 text-[#000000]" />
                        ...
                        <ul className="space-y-1.5">
                            {signal.indicatorsToWatch.map((ind) => (
                                <li key={ind} className="text-sm text-gray-700 flex gap-2">
                                    <ChevronRight className="w-4 h-4 text-[#000000] shrink-0 mt-0.5" />
                                    <span>{ind}</span>
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <SwotColumn
                            title="Opportunities"
                            icon={<ArrowUpRight className="w-4 h-4 text-[#000000]" />}
                ...
                {onApplyToPl && (
                    <div className="border-t border-gray-200 px-6 py-3 flex justify-end bg-gray-50/95 shrink-0">
                        <button
                            ...
                            className="px-4 py-2 text-sm font-semibold rounded-lg bg-[#000000] text-white hover:bg-[#000000] transition-colors"
                        >
            ...
            >
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                    <div className="flex items-start gap-4">
                        <div className="p-3 rounded-xl bg-[#000000] text-white shrink-0">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-3 leading-relaxed flex gap-2">
                                <Sparkles className="w-4 h-4 text-[#000000] shrink-0 mt-0.5" />
                ...
                <div className="grid gap-4">
                    {EXTERNAL_COMPETITIVE_SIGNALS.map((signal) => {
                        ...
                        return (
                            <div
                                key={signal.id}
                                className="flex bg-white rounded-xl shadow-sm border border-gray-200 hover:border-[#000000]/40 hover:shadow-md transition-all overflow-hidden group"
                            >
                                <button
                                    type="button"
                                ...
                                >
                                    <div className="flex items-start justify-between gap-4">
                                        <div className="flex gap-3 min-w-0">
                                            <span className="flex items-center justify-center w-9 h-9 rounded-full bg-[#000000] text-white text-sm font-bold shrink-0">
                                                {signal.rank}
                                            </span>
                                            <div className="min-w-0">
                                                <p className="text-[11px] font-semibold uppercase tracking-wide text-[#000000]">
                                                    {signal.category}
                                                </p>
                                                <h4 className="text-base font-semibold text-gray-900 mt-0.5 group-hover:text-[#000000] transition-colors">
                                                    {signal.title}
                                                </h4>
                                                <p className="text-sm text-gray-600 mt-2 leading-snug">{signal.summary}</p>
                                            </div>
                                        </div>
                                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-[#000000] shrink-0 mt-1" />
                                    </div>
                                ...
                                {onSyncPresetToPl && (
                                    <button
                                        ...
                                        className="shrink-0 px-4 border-l border-gray-100 text-gray-400 hover:text-[#000000] hover:bg-gray-50 transition-colors flex items-center"
                                    >
