...
export default function ScenarioRiskFrontierCard({
    ...
    const frontierSvg = useMemo(() => {
        ...
        return (
            <svg width={w} height={h} className="text-[#000000]" aria-hidden>
    ...
    return (
        <div className="mt-6 border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden">
            <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 bg-gradient-to-r from-[#f8fafc] to-white border-b border-gray-100">
                <div>
                    <p className="text-sm font-semibold text-[#000000]">Risk & allocation analytics</p>
                ...
                <button
                    ...
                    onClick={onRun}
                    disabled={loading}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#000000] text-white text-sm font-medium hover:bg-[#000000] disabled:opacity-50"
                >
