...
export default function IndustryNewsTicker() {
    ...
    return (
        <div
            className="border-b border-[#001a3d] bg-gradient-to-r from-[#001433] via-[#000000] to-[#000000] text-white shadow-inner"
            role="region"
            aria-label="Health care &amp; pharmacy industry headlines ticker"
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2">
                <div className="flex items-center gap-3">
                    <div className="flex shrink-0 items-center gap-2 border-r border-white/15 pr-3">
                        ...
                        <div className="hidden sm:block leading-tight">
                            ...
                            <p className="text-[11px] font-semibold text-white/90">Health care &amp; pharmacy</p>
                        </div>
                    </div>
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-x-3 gap-y-1 border-t border-white/10 pt-1.5 text-[10px] text-white/45">
                    <span className="inline-flex items-center gap-1">
                        ...
                        Sources: Google News RSS + Healthcare Dive — situational awareness only.
                    </span>
