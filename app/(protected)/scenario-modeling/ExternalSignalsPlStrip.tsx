...
function bandShort(lowM: number, highM: number): string {
    ...
    return `${fmt(lowM)}–${fmt(highM)} Core OP`;
}
            ...
            <div className="max-w-7xl mx-auto px-6 py-3">
                <div className="flex items-center justify-between gap-3 mb-2">
                    <div className="flex items-center gap-2 min-w-0">
                        <Radar className="w-4 h-4 text-[#000000] shrink-0" />
                    ...
                    <button
                        ...
                        className="text-[11px] font-semibold text-[#000000] hover:text-[#000000] flex items-center gap-0.5 shrink-0"
                    >
                        Full analysis
                ...
                <div className="flex gap-2 overflow-x-auto pb-0.5 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                    {EXTERNAL_COMPETITIVE_SIGNALS.map((s) => (
                        <div
                            key={s.id}
                            className="flex shrink-0 rounded-xl border border-gray-200/90 bg-white shadow-sm hover:border-[#000000]/25 hover:shadow transition-all overflow-hidden"
                        >
                            <button
                                type="button"
                            ...
                            >
                                <span
                                    ...
                                    aria-hidden
                                />
                                <span className="text-[10px] font-bold text-[#000000] tabular-nums w-4 shrink-0">
                                    {s.rank}
                                </span>
                            ...
                            <button
                                ...
                                className="px-2.5 border-l border-gray-100 text-gray-400 hover:text-[#000000] hover:bg-gray-50 transition-colors"
