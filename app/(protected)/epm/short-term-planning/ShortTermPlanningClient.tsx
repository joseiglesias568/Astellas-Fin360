      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              onClick={handleSave}
              className="inline-flex items-center gap-1.5 rounded-lg bg-[#000000] px-3.5 py-2 text-xs font-medium text-white shadow-sm hover:bg-[#1A1A1A] transition-colors"
            >
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="w-full lg:w-[40%] space-y-5">
          {leversByCategory.map(([category, levers]) => (
            ...
            >
              <h3 className="text-xs font-semibold text-[#000000] uppercase tracking-wider mb-3">
                {category}
              </h3>
        ...
        <div className="w-full lg:w-[60%] space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <SummaryMetricCard
              ...
              icon={DollarSign}
              accentColor={revenueDelta >= 0 ? '#000000' : '#dc2626'}
            ...
            <SummaryMetricCard
              ...
              icon={TrendingUp}
              accentColor={oiDelta >= 0 ? '#000000' : '#dc2626'}
            ...
            <SummaryMetricCard
              ...
              icon={Percent}
              accentColor={marginDelta >= 0 ? '#000000' : '#dc2626'}
