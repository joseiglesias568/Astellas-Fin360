  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <SummaryMetricCard label="Operating Margin" value="15.0%" subtitle="Plan: 15.1%" icon={BarChart3} accentColor="#1A1A1A" trend="flat" trendLabel="-0.1pp" index={2} />
        <SummaryMetricCard label="Annual Target Progress" value="48%" subtitle="YTD Revenue / Full Year Plan" icon={Activity} accentColor="#000000" index={3} />
      </div>
