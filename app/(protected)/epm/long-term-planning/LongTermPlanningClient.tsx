                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm transition-colors ${
                      selectedMetric === metric
                        ? 'font-semibold text-[#000000] bg-[#F0F0F0]/40'
            ...
            <div className="flex items-center justify-between">
              ...
              {hasChanges && (
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs font-medium text-gray-500 hover:text-[#000000] transition-colors px-2 py-1 rounded-md border border-gray-200 hover:border-[#000000]/30"
                >
