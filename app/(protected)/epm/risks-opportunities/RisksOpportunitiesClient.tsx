    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <BarChart3 className="h-4 w-4 text-[#000000]" />
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          <AlertTriangle className="h-4 w-4 text-[#000000]" />
        ...
        <div className="mt-4 flex items-center justify-center gap-6 pt-3 border-t border-gray-100">
          ...
          <div className="text-center">
            <p className="text-[10px] text-[#000000] font-semibold uppercase tracking-wider">Expected</p>
            <p className="text-lg font-bold text-[#000000]">{formatM(adjustment.expectedCase)}</p>
          </div>
          <div className="flex items-center gap-2">
