          ...
          <div className="mt-6 px-3">
            <div className="rounded-lg bg-[#F0F0F0] p-3">
              <div className="flex items-start gap-2">
                <Info className="h-3.5 w-3.5 text-[#000000] mt-0.5 shrink-0" />
                <div>
                  <p className="text-[10px] font-semibold text-[#000000] leading-tight">
                    Connected to EPM Platform
                  </p>
                  <p className="text-[9px] text-[#000000]/70 mt-1 leading-relaxed">
                  ...
                  <button className="mt-2 flex items-center gap-1 text-[9px] font-semibold text-[#000000] hover:underline">
