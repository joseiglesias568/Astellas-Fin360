                ...
                <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between py-6">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <button className="px-4 py-1.5 text-sm bg-[#000000] text-white rounded-lg font-semibold hover:bg-[#000000] transition-all flex items-center space-x-2">
                                    ...
                                    <div key={phase.id} className="flex items-center space-x-4">
                                        <div className="flex-1">
                                            ...
                                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                                                <div
                                                    className={`h-full rounded-full transition-all ${phase.status === 'completed' ? 'bg-[#000000]' :
                                        ...
                                        <div className="w-24 text-right">
                                            {phase.status === 'completed' && <CheckCircle className="w-5 h-5 text-[#000000] inline" />}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-4 gap-4">
                            <div className="bg-white rounded-lg border border-gray-200 p-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{jeTotal}</p>
                                <p className="text-xs text-[#000000] mt-1">+1.1% vs last month</p>
                            </div>
                            <div className="bg-white rounded-lg border border-gray-200 p-4">
                                <div className="flex items-center justify-between mb-2">
                                ...
                                {volumeTrend.map((month) => (
                                    <div key={month.month} className="flex-1 flex flex-col items-center">
                                        <div className="w-full bg-[#F0F0F0] rounded-t" style={{
                                            ...
                                            <div className="text-xs font-medium text-center pt-2 text-[#000000]">{month.count}</div>
                                        </div>
                        ...
                        <div className="bg-white rounded-lg border border-gray-200">
                            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                                ...
                                <button className="text-sm text-[#000000] hover:text-[#000000] font-medium">View All</button>
                            </div>
                ...
                {activeTab === 'financial-results' && (
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <button className="px-3 py-2 text-sm bg-[#000000] text-white rounded-lg font-medium hover:bg-[#000000] transition-all">
                                Export Results
                            </button>
                        </div>
                                            ...
                                            {Object.entries(financialResults.pl).map(([key, values]) => {
                                                ...
                                                return (
                                                    <tr key={key} className={`text-sm ${key === 'operatingIncome' || key === 'netIncome' ? 'font-semibold bg-gray-50' : ''}`}>
                                                        ...
                                                        <td className={`text-right py-3 font-medium ${actualVsPrior >= 0 ? 'text-[#000000]' : 'text-red-600'
                                                            }`}>
                                                        ...
                                                        <td className={`text-right py-3 font-medium ${actualVsBudget >= 0 ? 'text-[#000000]' : 'text-red-600'
                                                            }`}>
                                            ...
                                            {monthEnd.trialBalance.map((row, idx) => {
                                                ...
                                                return (
                                                    <tr key={idx} className="text-sm">
                                                        ...
                                                        <td className={`text-right py-3 font-medium ${varVsPrior >= 0 ? 'text-[#000000]' : 'text-red-600'}`}>
                                                            {varVsPrior >= 0 ? '+' : ''}{varVsPrior.toFixed(1)}%
                                                        </td>
                                                        <td className="text-right py-3 text-gray-600">
                                                            ${(row.budget / 1000000).toFixed(0)}
                                                        </td>
                                                        <td className={`text-right py-3 font-medium ${varVsBudget >= 0 ? 'text-[#000000]' : 'text-red-600'}`}>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-6">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <button className="px-3 py-1.5 text-sm bg-[#000000] text-white rounded-lg font-medium hover:bg-[#000000] transition-all flex items-center space-x-2">
                                    ...
                                    <div key={adj.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                        <div className="flex items-start justify-between">
                                            ...
                                            <div className="text-right ml-4">
                                                ...
                                                <p className={`text-lg font-semibold ${adj.impact.pl >= 0 ? 'text-[#000000]' : 'text-red-600'}`}>
                ...
                {activeTab === 'commentary' && (
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center space-x-3">
                                    <Brain className="w-6 h-6 text-[#000000]" />
                                    <h3 className="text-lg font-semibold text-gray-900">AI-Generated Commentary</h3>
                                </div>
                                <button className="px-3 py-1.5 text-sm bg-[#000000] text-white rounded-lg font-medium hover:bg-[#000000] transition-all">
                                    Regenerate All
                                </button>
                            </div>
                            <div className="space-y-4">
                                        ...
                                        <div key={idx} className="p-4 bg-[#F0F0F0] rounded-lg border border-emerald-200">
                                            ...
                                            <div className="flex items-center space-x-3 mt-3">
                                                <button
                                                    ...
                                                    className="text-xs text-[#000000] hover:text-[#000000] font-medium disabled:text-gray-400 disabled:cursor-default"
                                                >
