...
const COMMODITY_COLORS: Record<string, { spot: string; hedge: string; icon: React.ElementType }> = {
    'Office Cap Rate': { spot: '#000000', hedge: '#10B981', icon: Building2 },
    'Industrial Cap Rate': { spot: '#000000', hedge: '#34D399', icon: Building2 },
    'Construction Cost Index': { spot: '#3B82F6', hedge: '#93C5FD', icon: Hammer },
    'Interest Rate Spread': { spot: '#F59E0B', hedge: '#FCD34D', icon: Zap },
    'Energy Costs': { spot: '#8B5CF6', hedge: '#C4B5FD', icon: Package },
    'Materials/Supplies': { spot: '#6B7280', hedge: '#D1D5DB', icon: Package },
};
...
// Approximate annual cost exposure allocation (% of ~$4.2B total operating costs)
const SPEND_ALLOCATION: Record<string, number> = {
    'Office Cap Rate': 0.30,           // ~$1,260M
    'Industrial Cap Rate': 0.15,       // ~$630M
    'Construction Cost Index': 0.25,   // ~$1,050M
    'Interest Rate Spread': 0.12,      // ~$504M
    'Energy Costs': 0.08,              // ~$336M
    'Materials/Supplies': 0.10,        // ~$420M
};

const TOTAL_COMMODITY_SPEND = 4200; // $M annual operating cost exposure
...
export default function CommodityTrackingClient({ commodityGroups }: Props) {
    ...
    const hedgeCoverageData = useMemo(() => {
        return commodityNames.map(name => ({
            name: name.replace('Materials/Supplies', 'Materials'),
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
            <motion.div className="max-w-7xl mx-auto space-y-6" {...stagger} animate="animate" initial="initial">
                ...
                <motion.div {...fadeUp} className="flex items-center justify-between">
                    <div>
                        <div className="flex items-center space-x-3 mb-1">
                            ...
                            <h1 className="text-2xl font-bold text-[#000000]">Cost Index Tracking</h1>
                        </div>
                ...
                <motion.div {...fadeUp}>
                    <h2 className="text-lg font-semibold text-[#000000] mb-4">Cost Index Trends</h2>
                ...
                <motion.div {...fadeUp} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h2 className="text-lg font-semibold text-[#000000]">Hedging Position Summary</h2>
                    </div>
                ...
                <motion.div {...fadeUp} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    <div className="flex items-center space-x-2 mb-2">
                        ...
                        <h2 className="text-lg font-semibold text-[#000000]">COGS Impact Simulator</h2>
                    </div>
                    <p className="text-xs text-gray-400 mb-6">
                        Adjust cost index changes to estimate impact on Astellas&apos;s annual API raw material and manufacturing cost exposure
                    </p>
                        ...
                        {cogsImpact.items.map(item => (
                            <div key={item.name} className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full h-2 rounded-lg appearance-none cursor-pointer accent-[#000000]"
                                    style={{
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500">Based on ~$4.2B annual operating cost exposure</p>
                                </div>
                            </div>
                ...
                <motion.div {...fadeUp} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <h2 className="text-lg font-semibold text-[#000000]">Commodity Price Detail</h2>
                    </div>
