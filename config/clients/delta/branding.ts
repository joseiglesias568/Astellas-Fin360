...
export const branding: BrandingConfig = {
  ...
  //   Delta Blue: #000000 (Pantone 654 C) — primary brand color
  //   Delta Red:  #C01933 (Pantone 187 C) — accent/action color
  //   Dark Navy:  #000000                  — deep backgrounds
  //   Light Blue: #009AC7                  — secondary accent
  colors: {
    primary: '#000000',      // Delta Blue (Pantone 654 C)
    primaryDark: '#000000',  // Dark Navy
    primaryLight: '#D6E4F0', // Light Delta Blue tint
    primaryAlt: '#009AC7',   // Delta Light Blue
    navBg: '#000000',        // Dark Navy nav background
    navBgLight: '#000000',   // Delta Blue nav highlight
