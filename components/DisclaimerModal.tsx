            ...
            {showDisclaimer && (
                <>
                    ...
                    >
                        ...
                        >
                            {/* Header */}
                            <div className="bg-gradient-to-r from-[#000000] to-[#000000] p-4 rounded-t-xl">
                            ...
                            <div className="p-6">
                                <p className="text-gray-900 font-medium mb-4">
                                    This platform is a demonstration prototype designed and built for CVS Health Corporation management reporting and financial analytics.
                                </p>

                                <div className="space-y-3 mb-5">
                                    <div className="flex items-start space-x-2">
                                        <div className="w-1.5 h-1.5 bg-[#D91E49] rounded-full mt-1.5 flex-shrink-0" />
                                ...
                                <div className="bg-[#F0F0F0] border border-[#000000]/20 rounded-lg p-3 mb-5">
                                ...
                                <button
                                    onClick={handleAcknowledge}
                                    className="w-full px-4 py-2.5 bg-gradient-to-r from-[#000000] to-[#000000] text-white font-medium rounded-lg hover:shadow-lg hover:shadow-[#000000]/30 transition-all"
                                >
                                    I Understand & Accept
                                </button>
                            </div>
