      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            <div className="p-2 bg-[#000000] rounded-lg shadow-sm">
              <Icon className="w-5 h-5 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold text-[#000000] leading-tight">{title}</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            {onToggleAI && (
              <button
                onClick={onToggleAI}
                className="p-2 rounded-lg text-[#000000] hover:bg-[#F0F0F0]/50 transition-colors"
                title="AI Assistant"
              >
