        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-4 text-xs">
            <span className="text-gray-500">
              <span className="font-bold text-[#000000]">{signedOff}</span> of {items.length} signed off
            </span>
            <span className="text-gray-500">
              ...
              <div key={item.id} className={`${isSelected ? 'bg-[#F0F0F0]/20' : ''}`}>
                <div className="px-5 py-3 grid grid-cols-12 gap-3 items-start">
                  ...
                  <div className="col-span-3 flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-[#000000]">{item.component}</span>
                  </div>
                    ...
                    {isEditing ? (
                      <div className="space-y-2">
                        <textarea
                          ...
                          rows={3}
                          className="w-full text-xs text-gray-700 border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-[#000000]/20 focus:border-[#000000]"
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="px-3 py-1 text-xs font-medium text-white bg-[#000000] rounded-lg hover:bg-[#000000] transition-colors"
                          >
                            Save
                          </button>
                          <button
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="flex items-start gap-1.5">
                          <Brain className="w-3 h-3 text-[#000000] mt-0.5 flex-shrink-0" />
                  ...
                  <div className="col-span-1 flex justify-center gap-1">
                    <button
                      ...
                      className="p-1.5 text-gray-400 hover:text-[#000000] hover:bg-gray-100 rounded-lg transition-colors"
