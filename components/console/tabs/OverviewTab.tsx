    ...
    <div className="space-y-6">
        ...
        <section className="bg-white rounded-xl border border-gray-200 shadow-sm">
          <div className="p-6">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h2 className="text-lg font-bold text-[#000000]">{performanceSummary.title}</h2>
                ...
                <div className="flex items-center gap-1 bg-gray-100 rounded-lg p-1">
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${
                      commentaryMode === 'analytics' ? 'bg-white text-[#000000] shadow-sm' : 'text-gray-500'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all ${
                      commentaryMode === 'user' ? 'bg-white text-[#000000] shadow-sm' : 'text-gray-500'
                    }`}
                  >
            ...
            <div className="mt-6 p-4 bg-[#F0F0F0]/30 rounded-lg border border-[#000000]/10">
              <h3 className="text-sm font-semibold text-[#000000] mb-3 flex items-center gap-1.5">
                <Lightbulb className="w-4 h-4" />
                Key Takeaways
              </h3>
              <ul className="space-y-2">
                {performanceSummary.keyTakeaways.map((takeaway, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-[#000000]">
                    <CheckCircle2 className="w-4 h-4 text-[#000000] mt-0.5 flex-shrink-0" />
                    <span>{takeaway}</span>
                  </li>
                ))}
              </ul>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm h-full p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-[#000000]">Needs Attention</h3>
      ...
      <section>
        <div className="flex items-center justify-between mb-3">
          <div>
            <h2 className="text-base font-semibold text-[#000000]">Driver Performance</h2>
      ...
      <section className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-[#000000]">Related Reports</h3>
          </div>
          <Link href="/report-hub" className="text-xs text-[#000000] hover:underline flex items-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2.5">
          {[
            ...
            <Link
              ...
              className="group bg-gray-50 hover:bg-[#F0F0F0]/30 border border-gray-200 hover:border-[#000000]/30 rounded-lg p-3 transition-all"
            >
              <div className="flex items-start justify-between mb-1.5">
                <h4 className="text-xs font-semibold text-gray-900 group-hover:text-[#000000] line-clamp-2">{report.name}</h4>
                <ExternalLink className="w-3 h-3 text-gray-400 group-hover:text-[#000000] flex-shrink-0 mt-0.5" />
              </div>
              <p className="text-[10px] text-gray-500 mb-1.5 line-clamp-2">{report.desc}</p>
              <span className="inline-block px-1.5 py-0.5 bg-emerald-100 text-[#000000] text-[10px] font-medium rounded-full">{report.freq}</span>
            </Link>
          ))}
        </div>
      </section>
