    ...
    <div className="space-y-5">
        ...
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#000000]/20 focus:border-[#000000] w-48"
            />
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-[#000000] text-white rounded-lg hover:bg-[#000000] transition-colors">
            <Download className="w-3.5 h-3.5" />
            Generate Report
          </button>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors ${showNotes ? 'bg-[#000000] text-white' : 'text-gray-600 hover:bg-gray-100'}`}
          >
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-5 py-3 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-[#000000]">Financial Performance</h3>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-5 py-3 border-b border-gray-100">
          <h3 className="text-sm font-semibold text-[#000000]">Driver-Based Metrics</h3>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#000000] focus:border-[#000000] resize-none"
              rows={2}
            />
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-3 py-1 text-xs font-medium text-white bg-[#000000] rounded-lg hover:bg-[#000000] disabled:opacity-40 transition-colors"
              >
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        <div className="flex items-center justify-between mb-3">
          <h4 className="text-sm font-semibold text-[#000000] flex items-center gap-2">
            <Bookmark className="w-4 h-4 text-[#000000]" />
            Drill to Detailed Reports
          </h4>
          <Link href="/report-hub" className="text-xs text-[#000000] hover:underline">
            Browse Report Hub
          </Link>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
          {[
            ...
            <Link
              ...
              className="group flex items-center gap-2.5 bg-gray-50 hover:bg-[#F0F0F0]/30 border border-gray-200 hover:border-[#000000]/30 rounded-lg p-3 transition-all"
            >
              <div className="min-w-0 flex-1">
                <div className="text-xs font-medium text-gray-900 group-hover:text-[#000000]">{report.name}</div>
                <div className="text-[10px] text-gray-500 truncate">{report.desc}</div>
              </div>
              <ExternalLink className="w-3.5 h-3.5 text-gray-400 group-hover:text-[#000000] flex-shrink-0" />
            </Link>
          ))}
        </div>
      </div>
...
function PLRowComponent({
  ...
  return (
    <>
      <tr
        className={`
          ${row.isTotal ? 'bg-[#000000]' : row.isCategory ? 'bg-gray-50/60' : 'hover:bg-gray-50/40'}
          ${hasChildren ? 'cursor-pointer' : ''}
        `}
        onClick={hasChildren ? onToggle : undefined}
      >
        <td className={`px-5 py-2.5 text-sm font-medium sticky left-0 z-[1] ${
          row.isTotal ? 'text-white bg-[#000000]' : row.isCategory ? 'text-[#000000] font-semibold bg-gray-50/60' : 'text-gray-700'
        }`}>
          <div className="flex items-center gap-2">
            {hasChildren && (
  ...
  return (
    <>
      <tr className="bg-gray-50/60 cursor-pointer" onClick={onToggle}>
        <td colSpan={5} className="px-5 py-2.5 text-xs font-semibold text-[#000000]">
          <div className="flex items-center gap-2">
