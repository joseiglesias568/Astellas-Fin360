          ...
          <div key={kpi.id} className="relative">
            ...
            <motion.button
              ...
              className={`w-full text-left bg-white rounded-xl border border-gray-200 border-l-4 ${borderColor} p-4 shadow-sm
                ...
                ${isExpanded ? 'ring-2 ring-[#000000]/20 shadow-md' : ''}`}
            >
              ...
              <div className="flex items-end justify-between mt-2">
                <div>
                  <div className="flex items-baseline gap-1">
                    <span className="text-2xl font-bold text-[#000000]">{kpi.value}</span>
                ...
                <SparklineChart
                  ...
                  width={64}
                  height={24}
                  color={kpi.status === 'critical' ? '#EF4444' : kpi.status === 'warning' ? '#F59E0B' : '#000000'}
                />
              </div>
              ...
              {!isExpanded && (
                <div className="flex items-center gap-1 mt-2 text-xs text-[#000000] opacity-60">
                  <span>Details</span>
                ...
                >
                  <div className="mt-2 bg-white rounded-xl border border-gray-200 shadow-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <h4 className="text-sm font-semibold text-[#000000]">Key Drivers</h4>
                    ...
                    {kpi.aiInsight && (
                      <div className="p-2.5 bg-[#F0F0F0]/40 rounded-lg border border-[#000000]/10 mb-3">
                        <div className="flex items-center gap-1.5 mb-1">
                          <Sparkles className="w-3 h-3 text-[#000000]" />
                          <span className="text-xs font-semibold text-[#000000]">AI Insight</span>
                        </div>
                        <p className="text-xs text-[#000000] leading-relaxed">{kpi.aiInsight}</p>
                      </div>
                    )}
                    ...
                    {kpi.driversTabId && onNavigateToDrivers && (
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 text-xs font-medium text-[#000000] hover:text-[#000000] transition-colors"
                      >
