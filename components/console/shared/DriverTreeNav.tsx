    ...
    <div>
      <button
        ...
        className={`w-full text-left flex items-center gap-2 px-3 py-2.5 rounded-lg transition-all group
          ${isSelected
            ? 'bg-[#F0F0F0] border-l-3 border-[#000000]'
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <span className={`text-sm truncate ${isSelected ? 'font-semibold text-[#000000]' : 'font-medium text-gray-700 group-hover:text-[#000000]'}`}>
              {node.name}
            </span>
