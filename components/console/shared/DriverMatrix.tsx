          ...
          >
            ...
            <div className="col-span-4">
              <div className="flex items-center gap-2">
                <span className="text-sm font-medium text-[#000000] group-hover:text-[#000000] transition-colors">
                  {driver.name}
                </span>
                <ChevronRight className="w-3.5 h-3.5 text-gray-300 group-hover:text-[#000000] transition-colors" />
              </div>
            ...
            <div className="col-span-2 flex justify-center">
              <div className="relative w-10 h-10">
                ...
                <span className="absolute inset-0 flex items-center justify-center text-xs font-bold text-[#000000]">
