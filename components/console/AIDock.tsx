                    ...
                    <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                      <div className={`max-w-[80%] px-3 py-2 rounded-lg text-sm ${
                        msg.role === 'user'
                          ...
                          : 'bg-[#F0F0F0]/40 text-[#000000] border border-[#000000]/10'
                      }`}>
                        {msg.role === 'ai' && (
                          <div className="flex items-center gap-1 mb-1">
                            <Sparkles className="w-3 h-3 text-[#000000]" />
                            <span className="text-[10px] font-semibold text-[#000000]">AI</span>
                          </div>
                        )}
                        {msg.text}
                      </div>
          ...
          <div className="bg-white border border-gray-200 rounded-t-xl shadow-lg px-4 py-3">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                disabled={!query.trim()}
                className="p-2 bg-[#000000] text-white rounded-lg hover:bg-[#000000] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
