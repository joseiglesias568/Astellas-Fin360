    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                >
                    {/* Header */}
                    <div className="bg-gradient-to-r from-[#000000] to-[#000000] p-6 text-white">
                    ...
                    <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                        {isSearching ? (
                            <div className="flex flex-col items-center justify-center py-20">
                                <div className="w-16 h-16 border-4 border-[#000000] border-t-transparent rounded-full animate-spin mb-4"></div>
                            ...
                            <div className="space-y-6">
                                            ...
                                            <div key={idx} className="bg-white border border-gray-200 rounded-lg p-4">
                                                <div className="flex items-start justify-between mb-2">
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        ...
                                                        <span className="text-xs font-bold text-[#000000]">{finding.confidence}%</span>
                                                    </div>
                                                </div>
                                                                ...
                                                                return (
                                                                    <div key={i}>
                                                                        ...
                                                                        <div className="w-full bg-gray-200 rounded-full h-2">
                                                                            <div
                                                                                className={`h-2 rounded-full ${d.change !== undefined && d.change < 0 ? 'bg-red-400' : 'bg-[#000000]'
                                                                                    }`}
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-4 flex items-center">
                                        <Building className="w-5 h-5 mr-2 text-[#000000]" />
                                        Related Business Drivers
                                    </h3>
                                ...
                                <div>
                                    <h3 className="font-semibold text-gray-900 mb-4 flex items-center">
                                        <Brain className="w-5 h-5 mr-2 text-[#000000]" />
                                        AI Recommendations
                                    </h3>
                                    <div className="bg-gradient-to-br from-[#F0F0F0] to-emerald-50 rounded-xl p-5 border border-[#000000]/20">
                                        <div className="space-y-3">
                                            {searchResults.recommendations?.map((rec: string, idx: number) => (
                                                <div key={idx} className="flex items-start space-x-3">
                                                    <div className="w-7 h-7 rounded-full bg-[#000000] text-white flex items-center justify-center flex-shrink-0 text-sm font-bold">
                                                        {idx + 1}
                                                    </div>
                                ...
                                {searchResults.dataQuality && (
                                    <div className="bg-gray-50 rounded-xl p-5 border border-gray-200">
                                        <h3 className="font-semibold text-gray-900 mb-4 flex items-center">
                                            <LineChart className="w-5 h-5 mr-2 text-[#000000]" />
                                            Data Quality & Transparency
                                        </h3>
