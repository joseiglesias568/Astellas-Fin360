                ...
                <div className="flex items-center gap-3 pt-1 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="text-[8px] text-gray-400">CVS Health</span>
                        </div>
                        <div className="flex items-center gap-1">
        ...
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-[#000000] rounded" /><span className="text-[9px] text-gray-400">Actual</span></div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#000000]" /><span className="text-[9px] text-gray-400">Mainline</span></div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#000000]" /><span className="text-[9px] text-gray-400">Portfolio</span></div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-[#000000] rounded" /><span className="text-[9px] text-gray-400">Occupancy</span></div>
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-gray-300 rounded" /><span className="text-[9px] text-gray-400">Target</span></div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#D91E49]" /><span className="text-[9px] text-gray-400">CVS Health</span></div>
                ...
                <ComposedChart data={data as any[]} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
                    ...
                    <Tooltip
                        ...
                        formatter={(value: number, name: string) => {
                            ...
                            return [`$${(value / 1000).toFixed(1)}B`, name === 'vznRevenue' ? 'CVS Health Revenue' : 'Peer Revenue'];
                        }}
                    />
            ...
            {stats && (
                <div className="flex items-center gap-4 pt-1 border-t border-gray-100">
                    <div className="text-center flex-1">
                        <p className="text-[9px] text-gray-400">CVS Health Rev</p>
        ...
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-[#000000] rounded" /><span className="text-[9px] text-gray-400">Margin</span></div>
                </div>
            </div>
            <ResponsiveContainer width="100%" height={140}>
                <ComposedChart data={data as any[]} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#000000]" /><span className="text-[9px] text-gray-400">Adoption</span></div>
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-gray-300 rounded" /><span className="text-[9px] text-gray-400">Target</span></div>
                </div>
            </div>
            <ResponsiveContainer width="100%" height={140}>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#000000]" /><span className="text-[9px] text-gray-400">Leasing</span></div>
    ...
    return (
        <div className="space-y-1">
            <div className="flex items-center justify-between mb-1">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-sm bg-[#000000]" /><span className="text-[9px] text-gray-400">Actual</span></div>
                    <div className="flex items-center gap-1"><div className="w-2 h-0.5 bg-gray-300 rounded" /><span className="text-[9px] text-gray-400">Target</span></div>
                </div>
            </div>
            <ResponsiveContainer width="100%" height={140}>
