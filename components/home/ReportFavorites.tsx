    ...
    return (
        <div>
            <div className="mb-5 flex items-center justify-between">
                ...
                <Link
                    href="/report-hub"
                    className="flex items-center text-sm font-medium text-[#000000] hover:text-[#1A1A1A] transition-colors"
                >
                    See All
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {favoriteReports.map((report) => (
                    <motion.div
                        ...
                        className="bg-white rounded-xl border border-gray-200/80 hover:border-[#000000]/20 hover:shadow-md transition-all cursor-pointer group"
                    >
                        <div className="p-4">
                            {/* Category + Favorite */}
                            ...
                            <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                                ...
                                <div className="flex items-center text-xs font-medium text-[#000000] group-hover:text-[#1A1A1A] transition-colors">
