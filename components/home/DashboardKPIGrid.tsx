                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                                {category.kpis.map((kpi, idx) => (
                                                    <motion.div
                                                        ...
                                                        className="bg-gray-50/80 rounded-xl border border-gray-100 hover:border-[#000000]/20 hover:shadow-md hover:bg-white transition-all cursor-pointer overflow-hidden group"
                                                    >
                                                        {/* Status bar */}
                                                        <div className={`h-0.5 ${
                                                            kpi.status === 'critical' ? 'bg-red-500' :
                                                        ...
                                                        <div className="p-4">
                                                            ...
                                                            <div
                                                                ...
                                                                className="flex items-center justify-between text-xs font-medium text-[#000000] group-hover:text-[#1A1A1A] transition-colors"
                                                            >
