        ...
        <button
          ...
          className={`${btnPadding} rounded transition-all duration-150 ${
            rating === 'up'
              ...
              : 'text-gray-300 hover:text-[#000000] hover:bg-[#F0F0F0]/50'
          }`}
          title="Helpful"
        >
          ...
          >
            <div className="space-y-1.5 pt-1">
              <textarea
                ...
                className="w-full text-xs p-2 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-1 focus:ring-[#000000]/30 bg-white"
                rows={2}
                autoFocus
              />
              <button
                onClick={handleSubmitComment}
                className="flex items-center gap-1 px-3 py-1 bg-[#000000] text-white text-xs rounded-lg hover:bg-[#1A1A1A] transition-colors"
              >
