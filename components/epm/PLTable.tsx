            ...
            return (
              <motion.tr
                ...
                className={`border-b border-gray-100 transition-colors ${
                  isSelected ? 'bg-[#000000]/5 border-l-2 border-l-[#000000]' :
              ...
              >
                ...
                } ${isIndent ? 'pl-6' : ''} ${isSelected ? 'bg-[#000000]/5' : ''}`}>
                  <div className="flex items-center gap-1.5">
                    {isClickable && (
                      <ChevronRight className={`h-3 w-3 transition-transform ${isSelected ? 'rotate-90 text-[#000000]' : 'text-gray-300'}`} />
                    )}
                    {row.lineItem}
                  </div>
                </td>
