...
export default function DriverDetailPanel({ lineItem, row, periods, drivers }: DriverDetailPanelProps) {
  ...
  return (
    <motion.div
      ...
      className="bg-[#000000]/5 rounded-xl p-5 mt-3 space-y-5"
    >
      ...
      <div className="bg-white rounded-lg p-3 border border-gray-100">
        ...
        <div className="flex items-center gap-4 mt-2 px-2">
          <div className="flex items-center gap-1.5 text-[10px] text-gray-500">
            <div className="w-4 h-0.5 bg-[#000000] rounded" />
            <span>ML Forecast</span>
          </div>
          <div className="flex items-center gap-1.5 text-[10px] text-gray-500">
            <div className="w-4 h-0.5 bg-[#000000] rounded" style={{ borderTop: '2px dashed #000000' }} />
            <span>Actuals</span>
          </div>
          <div className="flex items-center gap-1.5 text-[10px] text-gray-500">
